  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500">Bootstrap Tables</li>
        <li class="breadcrumb-item f-w-500 active">Table Components</li>
      </ol>
    </nav>
  </div>
</div>
                ...
                <table class="table table-bordered">
                  <tbody>
                    <tr>
                      ...
                      <td><span>Bootstrap includes six predefined button styles, each serving its own semantic
                          purpose.</span></td>
                    </tr>
                    <tr>
                      <td>Round Buttons</td>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="dropdown-menu">
                          <h6 class="dropdown-header">Dropdown header</h6><a class="dropdown-item"
                ...
                <table class="table table-bordered">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p><span>Alerts are available for any length of text, as well as an optional dismiss button. Add
                            <code> alert alert-primary</code>,<code> alert alert-secondary</code>,<code> alert alert-success</code>,<code> alert alert-info</code>
                            classes for alert with all theme colors.</span></p>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <div class="alert alert-primary">
                          <p><strong>Success!</strong> You should <a class="alert-link font-light" href="#!">read this
                              message</a>.</p>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td><span>Add a dismiss button and the<code> alert alert-dismissable </code>class, which adds
                          extra padding to the right of the alert and positions the<code>close</code>a link On the
                          dismiss button, add the data-bs-dismiss="alert" attribute, which triggers the JavaScript
                          functionality. Be sure to use the<code>a</code>element with it for proper behavior across all
                          devices. To animate alerts when dismissing them, be sure to add the .fade and .in
                          classes.</span></td>
                    </tr>
                    <tr>
                      <td>Alerts with icons</td>
                      <td>
                        <div class="alert alert-primary inverse alert-dismissible fade show" role="alert"><i
                            class="icofont icofont-heart-alt"></i>
                ...
                <table class="table table-bordered checkbox-td-width">
                  <tbody>
                    <tr>
                      ...
                      <td><span>Uses a progress bar with class<code>progress-bar</code> and background color
                          <code>bg-primary, bg-secondary </code>also change</span></td>
                    </tr>
                    <tr>
                      ...
                      <td><span>Uses a gradient to create a striped effect class.
                          <code>progress-bar-striped</code></span></td>
                    </tr>
                    <tr>
                      ...
                      <td><span>Different sized progress. For Default progress, class need
                          <code>lg-progress-bar </code>on div.</span></td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table class="table table-bordered checkbox-td-width">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><span>Wrap with use
                          <code>checkbox-solid-*</code>,<code>primary, secondary, success, info, warning, danger </code>for
                          this style of checkbox.</span></td>
                    </tr>
                    <tr>
                      <td>Disable Check</td>
                      <td>
                      ...
                      <td><span>Wrap with use
                          <code>disabled </code>,<code>primary, secondary, success, info, warning, danger  </code>for
                          this style of checkbox disable.</span></td>
                    </tr>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><span>Wrap with use <code>.radio-*</code> and color
                          <code>.radio-*</code><code>primary , secondary , success , info</code> on Radio.</span></td>
                    </tr>
                    <tr>
                      <td>Checked Radio</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td><span>Wrap with use
                          <code>disabled </code>,<code>primary, secondary, success, info, warning, danger, light, dark </code>for
                          this style of checkbox disable.</span></td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table class="table table-bordered checkbox-td-width">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><span>Use for large and small select control add class
                          <code>form-control-*</code><code>lg, sm</code>.</span></td>
                    </tr>
                    <tr>
                ...
                <table class="table table-bordered checkbox-td-width">
                  <tbody>
                    <tr>
                      ...
                      <td class="w-50">
                        <input class="form-control input-primary" id="exampleFormControlInput1" type="email"
                    ...
                    <tr>
                      ...
                      <td><span>Use for basic input color add class
                          <code>input-air-*</code><code>primary, secondary, success, info </code>.on input</span></td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table class="table table-bordered">
                  <tbody>
                    <tr>
                      ...
                      <td><span>Use the <code>.badge</code> class, followed by. with badge color use class
                          <code>.badge-*</code><code>primary , secondary , success , info, warning, danger, light</code>
                          class within element to create default pill.</span></td>
                    </tr>
                    <tr>
                      <td>Label With Icon</td>
                      <td class="w-50 m-5">
                        <div class="badge badge-primary label-square"><i class="fa fa-paperclip fa-lg me-2"></i><span
                            class="f-14">Primary Label</span></div>
                      </td>
                ...
                <table class="table table-bordered">
                  <tbody>
                    <tr>
                      <td>Hover</td>
                      <td class="w-50">
                        <button class="btn btn-primary" type="button" data-original-title="btn btn-link btn-lg"
                    ...
                    <tr>
                      <td>Link</td>
                      <td class="w-50"><a class="btn btn-primary" href="#" data-bs-toggle="tooltip" title=""
                          role="button" data-original-title="Hooray!">Link</a></td>
                    ...
                    <tr>
                      ...
                      <td class="w-50">
                        <button class="btn btn-outline-primary" type="button"
                          data-original-title="btn btn-outline-danger-2x" title="">Primary</button>
                      </td>
                      <td><span>Use <code>btn btn-outline-info</code> for outline trigger. and button bold Border use
                          class <code>btn btn-outline-dark-2x</code></span></td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table class="table table-bordered">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><span>Use class
                          <code>bg-*</code><code>Primary , Secondary , Success , Info , Warning , Danger</code>in span
                          with icon show switch <code>icon-state </code>on div.</span></td>
                    </tr>
                    <tr>
