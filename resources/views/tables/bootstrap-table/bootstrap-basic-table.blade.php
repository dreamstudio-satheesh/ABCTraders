  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Bootstrap Tables</li>
      </ol>
    </nav>
  </div>
</div>
...
@section('content')
<div class="container-fluid basic_table custom-scrollbar">
  <div class="row">
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Basic Table with Border Bottom Color</h2>
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr class="border-bottom-info">
                <th scope="row">3</th>
                <td> <img class="img-30 me-2" src="{{ asset('assets/images/user/3.jpg') }}" alt="profile">Elana John
                </td>
                <td>Cazale </td>
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Inverse Table</h2>
          <p class="f-m-light mt-1">
            Use a class <code>table-inverse</code> inside table element.</p>
        </div>
        <div class="table-responsive custom-scrollbar">
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Hoverable Rows with Horizontal Border</h2>
          <p class="f-m-light mt-1">
            Hoverable row use a class <code>table-hover</code> and for Horizontal border use a class
            <code>.table-border-horizontal</code> , Solid border Use a class<code>.border-solid .table </code>class.
          </p>
        </div>
            ...
            <tbody>
              <tr>
                ...
                <td class="d-flex align-items-center"><i class="bg-light-success font-success"
                    data-feather="alert-triangle"></i><span class="font-success">No Signal</span></td>
              ...
              <tr>
                ...
                <td class="d-flex align-items-center"><i class="bg-light-danger font-danger"
                    data-feather="alert-triangle"></i><span class="font-danger">Offline</span></td>
              ...
              <tr>
                <th scope="row">4</th>
                <td class="d-flex align-items-center"> <i class="bg-light-success font-success"
                    data-feather="check-circle"></i><span class="font-success">No Signal</span></td>
                <td>Astrid: NE Shared managed</td>
                <td>Negligible</td>
                <td>Triaged</td>
                <td>13.18</td>
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Inverse Table with Primary Background</h2>
          <p class="f-m-light mt-1">
            Use a class <code>.bg-info,.bg-success,.bg-warning and .bg-danger classes.</code> with light text on dark
            backgrounds inside table element.<br>To set the light background color use .bg-[color] class where [color]
            is the value of your selected color from stack color palette. So for teal color background class will be
            .bg-teal</p>
        </div>
        <div class="table-responsive custom-scrollbar">
      ...
      <div class="card title-line">
        <div class="card-header">
          ...
          <p class="f-m-light mt-1">
            ...
            find a table and understand what it’s about and decide if they want to read it.</p>
        </div>
    ...
    <div class="col-sm-6">
      <div class="card title-line">
        <div class="card-header">
          ...
          <p class="f-m-light mt-1">
            Similar to tables , use the modifier classes<code>.table-[color]</code> to make <code>thead </code>appear in
            any color.</p>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
    ...
    <div class="col-sm-6">
      <div class="card title-line">
        <div class="card-header">
          <h2>Striped Row with Inverse Table</h2>
          <p class="f-m-light mt-1">
            Use <code>.table-striped</code> to add zebra-striping to any table row within the <code></code>. This
            styling doesn't work in IE8 and below as :nth-child CSS selector isn't supported.</p>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
            <div class="table-responsive custom-scrollbar">
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          ...
          <p class="f-m-light mt-1">
            Use <code>.table-responsive"❴-sm|-md|-lg|-xl|-xxl❵"</code> functions like a heading for a table. It helps
            users with screen readers to find a table and understand what it’s about and decide if they want to read it.
          </p>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
    ...
    <div class="col-sm-12">
      <div class="card light-table-bg title-line">
        <div class="card-header">
          <h2>Responsive Tables With Light Background</h2>
          <p class="f-m-light mt-1">
            A <code>.table-responsive ,.light-card</code> inside table element.</p>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
            <div class="table-responsive custom-scrollbar">
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Sizing Tables</h2>
          <p class="f-m-light mt-1">
            Example of Extra large table, Add<code>.table-xl</code> class to the<code>.table</code> , Large table Add
            <code> .table-lg</code> , Default table Add <code>.table-de</code> , Small table Add
            <code>.table-sm </code>, Extra Small table Add <code>.table-xs</code>to create a table.
          </p>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Custom Table Color with Hover and Stripped</h2>
          <p class="f-m-light mt-1">
            Use class
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Dashed Border </h2>
          <p class="f-m-light mt-1">
            Dashed border use class <code>.table-dashed</code> , for Dotted border use class<code>.table-dotted</code>,
            for Double border use class<code>.table-Double</code></p>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
            <div class="table-responsive custom-scrollbar">
