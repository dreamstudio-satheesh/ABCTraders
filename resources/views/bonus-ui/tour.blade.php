  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Tour</li>
      </ol>
    </nav>
  </div>
</div>
  ...
  <div class="user-profile">
    <div class="row">
        ...
        <div class="card hovercard text-center">
          ...
          <div class="user-image">
            <div class="avatar"><img alt="" src="{{ asset('assets/images/user/7.jpg') }}"
                data-intro="This is yuri profile"></div>
            <div class="icon-wrapper"><i class="icofont icofont-pencil-alt-5"
                data-intro="Change yuri profile image here"></i></div>
          </div>
          <div class="info">
            <div class="row g-3" data-intro="This is your profile details">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    <div class="text-start ttl-sm-mb-0 tour-email">
                      <h6 class="tour-mb-space"><i class="fa fa-calendar"></i>   BOD</h6><span>02 January 2024</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-xl-4 order-sm-2 order-xl-2">
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    <div class="text-start ttl-sm-mb-0 tour-email">
                      <h6 class="tour-mb-space"><i class="fa fa-location-arrow"></i>   Location</h6><span>4377 Libby
                        Street Beverly Hills</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="col-sm-12" data-intro="This is your first Post">
        <div class="card">
          <div class="profile-img-style profile-img1-style">
            <div class="row g-2">
              <div class="col-sm-8">
            ...
            <hr>
            <h5 class="pb-3">Wonderful piece that successfully conveys the magnificence of the mountains and the natural
              world.</h5>
            ...
            <div class="img-container">
              <div id="aniimated-thumbnials"><a href="#!"><img class="img-fluid rounded"
                    src="{{ asset('assets/images/other-images/profile-style-img3.png') }}" alt="gallery"></a>
                <p class="block-ellipsis pt-3">The curved canvas is enclosed in a complex frame that the artist created
                  but that his buddy Gottlieb Christian Kuhn carved. A variety of Christian symbols are depicted on the
                  frame, including the faces of five infant angels, a star, grapes, vines, corn, and God's eye.Many of
                  the Romantic elements and subjects that he would explore throughout his career are present in this
                  work, one of his earliest, most notable of which is the landscape's significant significance. In spite
                  of the altarpiece's inclusion of a crucifix, the emphasis is<a class="txt-danger"
                    href="{{ route('admin.blog-single') }}" target="_blank"> read more</a></p>
              </div>
            </div>
            <div class="like-comment mt-4">
              <ul class="list-inline">
                <li class="list-inline-item b-r-gray">
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="profile-img-style profile-img1-style">
            ...
            <div class="row g-3 mt-4 pictures" id="aniimated-thumbnials-2"><a class="col-sm-6" href="#!">
          ...
          <div class="profile-img-style profile-img1-style">
            ...
            <div class="row">
              <div class="col-lg-12 col-xl-4">
                <div id="aniimated-thumbnials-3"><a href="#!"><img class="img-fluid rounded"
                      src="{{ asset('assets/images/other-images/sidebar-bg.jpg') }}" alt="nature"></a></div>
              </div>
              <div class="col-xl-8">
