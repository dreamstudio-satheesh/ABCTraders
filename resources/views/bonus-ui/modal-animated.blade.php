  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Animated Modal</li>
      </ol>
    </nav>
  </div>
</div>
              ...
              <div class="animate-img" id="animation-box">
                <div class="card">
                  <div class="animate-widget">
                    <div><img class="img-fluid" src="{{ asset('assets/images/slider/6.jpg') }}" alt="drawing room">
                    </div>
                    <div class="text-center p-25">
                      <h3>It&apos;s Magic!!</h3>
                      <p class="text-muted mb-0"> Select the animation options given below and then click on the launch
                        button.</p>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xl-6">
              <form class="form-inline theme-form row animated-modal">
                ...
                <div class="mt-2 text-center w-100">
                  <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#myModal">Launch
                    modal</button>
                </div>
              </form>
            </div>
                ...
                <div class="modal-body">
                  <div class="card">
                    <div class="animate-widget">
                      ...
                      <div class="text-center p-25">
                        <p class="text-muted mb-0"><strong class="txt-danger">Wow!!!</strong> It's so beautiful
                          animations in yuri theme...</p>
                      </div>
                    </div>
                  </div>
                </div>
