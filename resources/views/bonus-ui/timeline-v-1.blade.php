  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Timeline</li>
      </ol>
    </nav>
  </div>
</div>
  ...
  <div class="row">
          ...
          <ul class="timeline-lists">
            <li class="d-flex">
              ...
              <div class="w-100 ms-3">
                <p class="d-flex justify-content-between mb-2"><span class="date-content light-background">2 Feb
            ...
            <li class="d-flex">
              ...
              <div class="w-100 ms-3">
                <p class="d-flex justify-content-between mb-2"><span class="date-content light-background">22 March
            ...
            <li class="d-flex">
              ...
              <div class="w-100 ms-3">
                <p class="d-flex justify-content-between mb-2"><span class="date-content light-background">16 May
                    2024</span><span>1:22 AM</span></p>
                <h6>INVEST IN A NEW HOSTING PLAN<span class="dot-notification"></span></h6>
                <p class="f-light">today at 2 pm AM, purchase a new hosting package as agreed upon with the management
                  team.</p>
              </div>
            </li>
            <li class="d-flex">
              ...
              <div class="w-100 ms-3">
                <p class="d-flex justify-content-between mb-2"><span class="date-content light-background">23 Nov
            ...
            <li class="d-flex">
              ...
              <div class="w-100 ms-3">
                <p class="d-flex justify-content-between mb-2"><span class="date-content light-background">12 Dec
            ...
            <li class="d-flex">
              ...
              <div class="w-100 ms-3">
                <p class="d-flex justify-content-between mb-2"><span class="date-content light-background">02 Jan
                    2024</span><span>6:56 AM</span></p>
                ...
                <div class="text-muted">A fresher's interview is to be conducted
                  <div class="list-group main-lists-content"><a
                      ...
                      <div class="d-flex w-100 justify-content-between align-items-center">
                        <div class="list-wrapper"><img class="list-img img-fluid me-0 mb-0"
                        ...
                        <div class="timeline-icon"><i class="icon-facebook"></i><i class="icon-google"> </i><i
                            class="icon-twitter-alt"></i></div>
                      </div>
                ...
                <div class="text-muted">2209 Leverton Cove RoadSpringfield, MA 01109
                  <div class="designer-details">
                    <div class="designer-profile">
                      <div class="designer-wrap"><img class="designer-img img-fluid"
    ...
    <div class="col-xxl-4 col-xl-5 notification box-col-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Variation Timeline </h2>
          <p class="f-m-light mt-1">
            Use the <code>.activity-dot-primary </code>through rounded animations.</p>
        </div>
        <div class="card-body dark-timeline">
          <ul class="timeline-lists variation-timeline">
            <li class="d-flex">
              <div class="activity-dot-primary"></div>
              <div class="w-100 ms-3">
                <p class="d-flex justify-content-between mb-2"><span class="date-content light-background">8th March,
                    2024 </span><span>1 day ago</span></p>
            ...
            <li class="d-flex">
              ...
              <div class="w-100 ms-3">
                <p class="d-flex justify-content-between mb-2"><span class="date-content light-background">5th Feb, 2024
                  </span><span>Today</span></p>
                <h6>Added Bew Items<span class="dot-notification"></span></h6><span class="f-light">Timeline showcasing
                  historical events...</span>
                <div class="recent-images">
                  <ul>
                    <li>
                      <div class="recent-img-wrap"><img src="{{ asset('assets/images/product/products/1.png') }}"
                          alt="chair"></div>
                    </li>
                    <li>
                      <div class="recent-img-wrap"><img src="{{ asset('assets/images/product/products/2.png') }}"
                          alt="chair"></div>
                    </li>
                    <li>
                      <div class="recent-img-wrap"><img src="{{ asset('assets/images/product/products/3.png') }}"
                          alt="men t-shirt"></div>
                    </li>
                  </ul>
                </div>
            ...
            <li class="d-flex pb-0">
              ...
              <div class="w-100 ms-3">
                <p class="d-flex justify-content-between mb-2"><span class="date-content light-background">20th Sep,
                    2024 </span><span>12:00 PM</span></p>
          ...
          <div class="list-inline events timeline-list timeline-border row">
            <div class="col-xxl-4 col-sm-6">
              <div>
                <div class="list-inline-item event-list">
                  <div class="px-4">
                    <div class="event-date alert-light-primary txt-primary">11 Jan</div>
                    <h5>Conference </h5>
                    <p class="text-muted">Conferences are intended to bring individuals with similar interests together
                      to discuss problems.</p>
                    <div class="read-more-btn"><a class="btn btn-primary px-3" href="#!">Read more</a></div>
                  </div>
                </div>
              ...
              <div>
                <div class="list-inline-item event-list">
                  <div class="px-4">
                    ...
                    <h5>Meet-up</h5>
                    <p class="text-muted">You may connect with males from all around the world using the friend-forward.
                    </p>
                    <div class="read-more-btn"><a class="btn btn-primary px-3" href="#!">Read more</a></div>
                  </div>
                </div>
            ...
            <div class="col-xxl-4 horizontal-timeline">
              <div>
                <div class="list-inline-item event-list">
                  <div class="px-4">
                    <div class="event-date alert-light-danger txt-danger">22 March</div>
                    <h5>Meeting</h5>
                    <p class="text-muted">If several languages coalesce the grammar of the resulting simple and regular
              ...
              <div>
                ...
                <div class="list-inline-item event-list">
                  <div class="px-4">
                    ...
                    <h5>Conference </h5>
                    <p class="text-muted">A gathering of two or more people to talk about issues of interest.</p>
              ...
              <div>
                ...
                <div class="list-inline-item event-list">
                  <div class="px-4">
                    ...
                    <h5>Launch Theme</h5>
                    <p class="text-muted">Responsive Website is the approach that suggests website design and
                      development should respond.</p>
                    <div><a class="btn btn-primary px-3" href="#!">Read more</a></div>
                  </div>
                </div>
              </div>
    ...
    <div class="col-sm-12 box-col-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Timeline</h2>
          <p class="f-m-light mt-1">
            This is a yuri timeline chart.</p>
        </div>
        <div class="card-body">
          <!-- cd-timeline Start-->
          <section class="cd-container" id="cd-timeline">
            <div class="cd-timeline-block">
              ...
              <div class="cd-timeline-content">
                ...
                <h5 class="m-0">Established new the app-ideas repository.</h5>
                <p class="mb-0">
                  developers who are just beginning their learning process. those who often concentrate on developing
            ...
            <div class="cd-timeline-block">
              ...
              <div class="cd-timeline-content">
                ...
                <h5 class="m-0">Implemented the program for weekly code challenges.</h5>
                <p class="mb-0">
                  Challenges <em class="txt-danger">help you build problem-solving skills, better understand the
                    programming. </em>If you want to improve your skills in programming. </p>
                <div class="ratio ratio-21x9 m-t-20">
                  <iframe src="https://www.youtube.com/embed/D0UnqGm_miA?si=OYFHxY3xaKl9gHEm"
            ...
            <div class="cd-timeline-block">
              ...
              <div class="cd-timeline-content">
                ...
                <h5 class="m-0">Research about most recent design trends.</h5>
                <p class="mb-0">
            ...
            <div class="cd-timeline-block">
              ...
              <div class="cd-timeline-content">
                ...
                <h5 class="m-0">Musical trends and predictability</h5>
                <p class="mb-0">
                  So, the next time you listen to music, you might or might not consider how it's actively altering your
                  mood.</p>
                <audio controls="">
            ...
            <div class="cd-timeline-block">
              ...
              <div class="cd-timeline-content">
                ...
                <h5 class="m-0">Web-designer's meet-up</h5>
                <p class="mb-0">
            ...
            <div class="cd-timeline-block">
              ...
              <div class="cd-timeline-content">
                ...
                <h5 class="m-0">My Resolutions for 2024</h5>
                <p class="mb-0">
