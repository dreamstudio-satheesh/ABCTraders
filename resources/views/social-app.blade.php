    ...
    <div>
        ...
        <nav>
            <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
                ...
                <li class="breadcrumb-item f-w-500 active">Social App</li>
            </ol>
        </nav>
    </div>
</div>
                    ...
                    <div class="info market-tabs p-0">
                        <ul class="nav nav-tabs border-tab tabs-scoial" id="top-tab" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" id="top-friends" data-bs-toggle="tab"
                                    href="#friends" role="tab" aria-controls="friends" aria-selected="false">Friends</a>
                            </li>
                ...
                <div class="row">
                                ...
                                <div class="collapse show" id="collapseTwo" aria-labelledby="headingTwo"
                                    ...
                                    <div class="card-body social-status filter-cards-view">
                                        <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                            ...
                                            <div class="flex-grow-1">
                                                <h6>Bucky Barnes</h6><span class="d-block">winter@gmail.com</span>
                                            </div>
                                        </div>
                                        <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                            ...
                                            <div class="flex-grow-1">
                                                <h6>Sarah Loren</h6><span class="d-block">barnes@gmail.com</span>
                                            </div>
                                        </div>
                                        <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                            ...
                                            <div class="flex-grow-1">
                                                <h6>Jason Borne</h6><span class="d-block">jasonb@gmail.com</span>
                                            </div>
                                        </div>
                                        <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                src="{{ asset('assets/images/user/8.jpg') }}" alt="">
                                            <div class="social-status social-offline"></div>
                                            <div class="flex-grow-1">
                                                <h6>Comeren Diaz</h6><span class="d-block">comere@gmail.com</span>
                                            </div>
                                        </div>
                                        <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                            ...
                                            <div class="social-status social-online"></div>
                                            <div class="flex-grow-1">
                                                <h6>Andew Jon</h6><span class="d-block">andrewj@gmail.com</span>
                                            </div>
                                        </div>
                                        <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                            ...
                                            <div class="social-status social-busy"></div>
                                            <div class="flex-grow-1">
                                                <h6>Johny Waston</h6><span class="d-block">johny@gmail.com</span>
                                            </div>
                                        </div>
                                        <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                            ...
                                            <div class="social-status social-offline"></div>
                                            <div class="flex-grow-1">
                                                <h6>Johny William</h6><span class="d-block">johnyw@gmail.com</span>
                                            </div>
                                        </div>
                                        <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        </div><img class="img-fluid post-blog" alt=""
                                            src="{{ asset('assets/images/social-app/timeline-1.png') }}">
                                        <div class="timeline-content">
                                            <p>She is a certified personal trainer and nutritionist who uses her blog as
                                                a place to share cooking ideas, training photos, and inspirational
                                                messages for other fitness fans.</p>
                                            ...
                                            <div class="social-chat">
                                                <div class="your-msg">
                                                    <div class="d-flex"><img
                                                        ...
                                                        <div class="flex-grow-1"><span class="f-w-600">Jason Borne
                                                                <span>1 Year Ago <i
                                                ...
                                                <div class="other-msg">
                                                    <div class="d-flex"><img
                                                        ...
                                                        <div class="flex-grow-1"><span class="f-w-600">Alexendra
                                                                Dhadio <span>1 Month Ago <i
                                                                        class="fa fa-reply font-primary"></i></span></span>
                                                ...
                                                <div class="other-msg">
                                                    <div class="d-flex"><img
                                                        ...
                                                        <div class="flex-grow-1"><span class="f-w-600">Olivia Jon
                                                                <span>15 Days Ago <i
                                                                        class="fa fa-reply font-primary"></i></span></span>
                                                ...
                                                <div class="your-msg">
                                                    <div class="d-flex"><img
                                                            class="img-50 img-fluid m-r-20 rounded-circle" alt=""
                                                            src="{{ asset('assets/images/user/1.jpg') }}">
                                                        <div class="flex-grow-1"><span class="f-w-600">Issa Bell
                                                                <span>1 Year Ago <i
                                                                        class="fa fa-reply font-primary"></i></span></span>
                                                            <p>we are working for the dance and sing songs. this car is
                                                                very awesome for the youngster. please vote this car and
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <div class="input-group text-box">
                                                            <input class="form-control input-txt-bx" type="text"
                                                                name="message-to-send" placeholder="Post Your commnets">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="timeline-content">
                                            <p>Richard Bernabe creates a photography blog with a worldly viewpoint by
                                                fusing his passions for writing and travel photography. He claims that
                                                adventure is what motivates his trip photography.</p>
                                            <div class="like-content"><span><i
                                                        class="fa fa-heart font-danger"></i></span><span
                                                    class="pull-right comment-number"><span>20 </span><span><i
                                                            class="fa fa-share-alt me-0"></i></span></span><span
                    ...
                    <div class="col-xl-3 xl-100 box-col-12">
                        <div class="default-according style-1 faq-accordion job-accordion" id="accordionoc1">
                            <div class="row">
                                <div class="col-xl-12 xl-50 box-col-6 order-xxl-i col-lg-6">
                                    <div class="card profile-intro">
                                        ...
                                        <div class="collapse show" id="collapseicon2" aria-labelledby="collapseicon2"
                                            ...
                                            <div class="card-body filter-cards-view"><span
                                                ...
                                                <div class="social-network theme-form">
                                                    ...
                                                    <button class="btn social-btn btn-fb text-center"><i
                                                            class="fa fa-facebook m-r-5"></i>Facebook</button>
                                                    <button class="btn social-btn btn-twitter text-center"><i
                                ...
                                <div class="col-xl-12 xl-30 box-col-6 order-xxl-iii col-lg-4 col-md-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <h2 class="mb-0">
                                                <button class="btn btn-link" data-bs-toggle="collapse"
                                        ...
                                        <div class="collapse show" id="collapseicon3" aria-labelledby="collapseicon3"
                                            ...
                                            <div class="card-body social-list filter-cards-view">
                                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle"
                                                        alt="" src="{{ asset('assets/images/user/2.png') }}">
                                                    <div class="flex-grow-1">
                                                        <h6>Bucky Barnes</h6><a href="#!">Add Friend</a>
                                                    </div>
                                                </div>
                                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle"
                                                        alt="" src="{{ asset('assets/images/user/3.png') }}">
                                                    <div class="flex-grow-1">
                                                        <h6>Sarah Loren</h6><a href="#!">Add Friend</a>
                                                    </div>
                                                </div>
                                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle"
                                                        alt="" src="{{ asset('assets/images/user/3.jpg') }}">
                                                    <div class="flex-grow-1">
                                                        <h6>Jason Borne</h6><a href="#!">Add Friend</a>
                                                    </div>
                                                </div>
                                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle"
                                                        alt="" src="{{ asset('assets/images/user/10.jpg') }}">
                                                    <div class="flex-grow-1">
                                                        <h6>Comeren Diaz</h6><a href="#!">Add Friend</a>
                                                    </div>
                                                </div>
                                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle"
                                                        alt="" src="{{ asset('assets/images/user/11.png') }}">
                                                    <div class="flex-grow-1">
                                                        <h6>Andew Jon</h6><a href="#!">Add Friend</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-12 xl-30 box-col-6 order-xxl-iv col-lg-4 col-md-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link" data-bs-toggle="collapse"
                                ...
                                <div class="col-xl-12 xl-40 box-col-6 order-xxl-v col-lg-4">
                                    <div class="card height-equals">
                                        <div class="card-header">
                                            <h2 class="mb-0">
                                                <button class="btn btn-link" data-bs-toggle="collapse"
                                        ...
                                        <div class="collapse show" id="collapseicon4" data-bs-parent="#accordion"
                                            ...
                                            <div class="card-body photos filter-cards-view">
                                                <ul class="common-flex latest-photos">
                                                    <li><img class="img-fluid" alt=""
                                ...
                                <div class="col-xl-12 box-col-6 order-xxl-vi">
                                    <div class="card">
                                        <div class="card-header">
                                            <h2 class="mb-0">
                                                <button class="btn btn-link" data-bs-toggle="collapse"
                                        ...
                                        <div class="collapse show" id="collapseicon13" data-bs-parent="#accordion"
                                            ...
                                            <div class="card-body avatar-showcase filter-cards-view">
                                                <ul class="common-flex">
                                                    <li><img class="img-50 rounded-circle"
                                                    ...
                                                    <li><img class="img-50 rounded-circle"
                                                            src="{{ asset('assets/images/user/2.png') }}" alt="#"></li>
                                                    <li><img class="img-50 rounded-circle"
                                                            src="{{ asset('assets/images/user/3.png') }}" alt="#"></li>
                                                    <li><img class="img-50 rounded-circle"
                                                            src="{{ asset('assets/images/user/6.jpg') }}" alt="#"></li>
                                                    <li><img class="img-50 rounded-circle"
                                                            src="{{ asset('assets/images/user/10.jpg') }}" alt="#"></li>
                                                    <li><img class="img-50 rounded-circle"
                                                            src="{{ asset('assets/images/user/14.png') }}" alt="#"></li>
                                                    <li><img class="img-50 rounded-circle"
                                                            src="{{ asset('assets/images/user/1.jpg') }}" alt="#"></li>
                                                    <li><img class="img-50 rounded-circle"
                                                            src="{{ asset('assets/images/user/4.jpg') }}" alt="#"></li>
                                                    <li><img class="img-50 rounded-circle"
                                                            src="{{ asset('assets/images/user/11.png') }}" alt="#"></li>
                                                    <li><img class="img-50 rounded-circle"
                ...
                <div class="row">
                                        ...
                                        <div class="row details-about">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="your-details your-details-xs"><span
                                                    ...
                                                    <p>Swimming, Surfing, Syuri Diving, Anime, Photography, Tattoos,
                                                        Street Art.</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="activity-log">
                                            <div class="my-activity">
                                                ...
                                                <p><span><i class="m-r-20" data-feather="thumbs-up"></i></span>Comeren
                                                    Diaz likes
                                                    your photos.</p>
                                                <p><span><i class="m-r-20" data-feather="user-plus"></i></span>Karlene
                                                    Lex and
                    ...
                    <div class="col-xl-3 xl-100 box-col-12">
                        <div class="default-according style-1 faq-accordion job-accordion" id="accordionoc3">
                            <div class="row">
                                <div class="col-xl-12 xl-50 box-col-6 col-md-6">
                                    <div class="card profile-intro">
                                        <div class="card-header">
                                            <h2 class="mb-0">
                                                <button class="btn btn-link" data-bs-toggle="collapse"
                                        ...
                                        <div class="collapse show" id="collapseicon7" aria-labelledby="collapseicon"
                                            data-bs-parent="#accordion" aria-controls="collapseicon7">
                                            <div class="card-body filter-cards-view">
                                                <h6 class="mb-2 d-block">About Me :</h6>
                                                <p>
                                                    Hi, I’m elana, I’m 30 and I work as a
                                                    web Designer for the “Daydreams”
                                                    Agency in Pier 56.
                                                </p>
                                                <h6 class="mb-2 d-block">Favourite TV shows :</h6>
                                                <p>
                                                    Breaking Good, RedDevil, People of
                                                    Interest, The Running Dead,
                                                    Found, American Guy.
                                                </p>
                                                <h6 class="mb-2 d-block">Favourite Music Bands :</h6>
                                                <p>
                                                    Breaking Good, RedDevil, People of
                                                    Interest, The Running Dead,
                                                    Found, American Guy.
                                ...
                                <div class="col-xl-12 xl-50 box-col-6">
                                    <div class="card">
                                        ...
                                        <div class="collapse show" id="collapseicon11" aria-labelledby="collapseicon11"
                                            data-bs-parent="#accordion">
                                            <div class="card-body social-list filter-cards-view">
                                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle"
                                                        alt="" src="{{ asset('assets/images/user/3.png') }}">
                                        ...
                                        <div class="collapse show" id="collapseicon9" data-bs-parent="#accordion"
                                            ...
                                            <div class="card-body photos filter-cards-view">
                                                <ul class="common-flex latest-photos">
                                                    ...
                                                    <li><img class="img-fluid" alt=""
                                                            src="{{ asset('assets/images/social-app/post-9.png') }}">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div class="card social-profile">
                            <div class="card-body">
                                <div class="social-img-wrap">
                                    <div class="social-img"><img src="{{ asset('assets/images/avtar/2.jpg') }}"
                                            alt="profile"></div>
                                    <div class="edit-icon">
                                        <svg>
                                            <use href="{{ asset('assets/svg/icon-sprite.svg#profile-check') }}">
                                            </use>
                                        </svg>
                                    </div>
                                </div>
                                <div class="social-details">
                                    <h5 class="mb-1 f-w-600"><a href="{{ route('admin.social-app') }}">Brooklyn
                                            Simmons</a>
                                    </h5>
                    ...
                    <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                        <div class="card social-profile">
                            <div class="card-body">
                                ...
                                <div class="social-details">
                                    <h5 class="mb-1 f-w-600"><a href="{{ route('admin.social-app') }}">Mark Jecno</a>
                                    </h5>
                                    <span class="f-light">@mark.jeco</span>
                                    <ul class="card-social">
                                        <li><a href="https://www.facebook.com/" target="_blank"><i
                                                    class="fa fa-facebook"></i></a></li>
                                        <li><a href="https://accounts.google.com/" target="_blank"><i
                                    ...
                                    <ul class="social-follow">
                                        <li>
                                            <h3 class="mb-0 f-w-600">875</h3><span class="f-light">Posts</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">12.0k</h3><span class="f-light">Followers</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">1400</h3><span class="f-light">Following</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                        <div class="card social-profile">
                            <div class="card-body">
                                ...
                                <div class="social-details">
                                    <h5 class="mb-1 f-w-600"><a href="{{ route('admin.social-app') }}">Dev John</a></h5>
                                    <span class="f-light">@john.dev</span>
                                    <ul class="card-social">
                                        <li><a href="https://www.facebook.com/" target="_blank"><i
                                                    class="fa fa-facebook"></i></a></li>
                                        <li><a href="https://accounts.google.com/" target="_blank"><i
                                    ...
                                    <ul class="social-follow">
                                        <li>
                                            <h3 class="mb-0 f-w-600">1,274</h3><span class="f-light">Posts</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">15.0k</h3><span class="f-light">Followers</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">1874</h3><span class="f-light">Following</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                        <div class="card social-profile">
                            <div class="card-body">
                                ...
                                <div class="social-details">
                                    <h5 class="mb-1 f-w-600"><a href="{{ route('admin.social-app') }}">Johan Deo</a>
                                    ...
                                    <ul class="social-follow">
                                        <li>
                                            <h3 class="mb-0 f-w-600">500</h3><span class="f-light">Posts</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">8.0k</h3><span class="f-light">Followers</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">570</h3><span class="f-light">Following</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                        <div class="card social-profile">
                            <div class="card-body">
                                ...
                                <div class="social-details">
                                    <h5 class="mb-1 f-w-600"><a href="{{ route('admin.social-app') }}">Douglas
                                            Reichel</a>
                                    </h5><span class="f-light">@reichel.douglas</span>
                                    <ul class="card-social">
                                        <li><a href="https://www.facebook.com/" target="_blank"><i
                                                    class="fa fa-facebook"></i></a></li>
                                        <li><a href="https://accounts.google.com/" target="_blank"><i
                                    ...
                                    <ul class="social-follow">
                                        <li>
                                            <h3 class="mb-0 f-w-600">460</h3><span class="f-light">Posts</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">2k</h3><span class="f-light">Followers</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">350</h3><span class="f-light">Following</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                        <div class="card social-profile">
                            <div class="card-body">
                                ...
                                <div class="social-details">
                                    <h5 class="mb-1 f-w-600"><a href="{{ route('admin.social-app') }}">Lisa lillian</a>
                                    </h5>
                                    <span class="f-light">@lisa.lillian</span>
                                    <ul class="card-social">
                                        <li><a href="https://www.facebook.com/" target="_blank"><i
                                                    class="fa fa-facebook"></i></a></li>
                                        <li><a href="https://accounts.google.com/" target="_blank"><i
                                    ...
                                    <ul class="social-follow">
                                        <li>
                                            <h3 class="mb-0 f-w-600">547</h3><span class="f-light">Posts</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">3.5k</h3><span class="f-light">Followers</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">822</h3><span class="f-light">Following</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                        <div class="card social-profile">
                            <div class="card-body">
                                ...
                                <div class="social-details">
                                    <h5 class="mb-1 f-w-600"><a href="{{ route('admin.social-app') }}">Olivia rose</a>
                                    </h5>
                                    <span class="f-light">@rose.olivia</span>
                                    <ul class="card-social">
                                        <li><a href="https://www.facebook.com/" target="_blank"><i
                                                    class="fa fa-facebook"></i></a></li>
                                        <li><a href="https://accounts.google.com/" target="_blank"><i
                                    ...
                                    <ul class="social-follow">
                                        <li>
                                            <h3 class="mb-0 f-w-600">868</h3><span class="f-light">Posts</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">1k</h3><span class="f-light">Followers</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">742</h3><span class="f-light">Following</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                        <div class="card social-profile">
                            <div class="card-body">
                                <div class="social-img-wrap">
                                    <div class="social-img"><img class="img-fluid"
                                            src="{{ asset('assets/images/user/2.png') }}" alt="profile"></div>
                                    <div class="edit-icon">
                                        <svg>
                                            <use href="{{ asset('assets/svg/icon-sprite.svg#profile-check') }}">
                                            </use>
                                ...
                                <div class="social-details">
                                    <h5 class="mb-1 f-w-600"><a href="{{ route('admin.social-app') }}">Sarah Karen</a>
                                    </h5>
                                    <span class="f-light">@karen.sarah</span>
                                    <ul class="card-social">
                                        <li><a href="https://www.facebook.com/" target="_blank"><i
                                                    class="fa fa-facebook"></i></a></li>
                                        <li><a href="https://accounts.google.com/" target="_blank"><i
                                    ...
                                    <ul class="social-follow">
                                        <li>
                                            <h3 class="mb-0 f-w-600">972</h3><span class="f-light">Posts</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">2.5k</h3><span class="f-light">Followers</span>
                                        </li>
                                        <li>
                                            <h3 class="mb-0 f-w-600">864</h3><span class="f-light">Following</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="my-gallery card-body row gallery-with-description" itemscope="">
                                <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                        ...
                                        <div class="caption">
                                            <h4>Johan Deo</h4>
                                            <p>An admin theme is a visually beautiful and practical design template
                                                created especially for a website's or application's backend.</p>
                                        </div>
                                    </a>
