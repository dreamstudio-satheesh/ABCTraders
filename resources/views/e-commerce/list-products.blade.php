    ...
    <div>
        ...
        <nav>
            <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
                ...
                <li class="breadcrumb-item f-w-500 active">Product list</li>
            </ol>
        </nav>
    </div>
</div>
                ...
                <div class="card-body">
                    <div class="list-product-header">
                        <div>
                            ...
                            <a class="btn btn-primary" href="{{ route('admin.add-post') }}"><i
                        ...
                        <table class="table" id="project-status">
                            ...
                            <tbody>
                                <tr class="product-removes">
                                    ...
                                    <td>
                                        <div class="product-action"><a href="{{ route('admin.add-product') }}">
                                                <svg>
                                ...
                                <tr class="product-removes">
                                    ...
                                    <td>
                                        <div class="rating"><i class="fa fa-star txt-warning"></i><i
                                                class="fa fa-star txt-warning"></i><i
                                                class="fa fa-star txt-warning"></i><i class="fa fa-star f-light"></i><i
                                                class="fa fa-star f-light"></i>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="product-action"><a href="{{ route('admin.add-product') }}">
                                ...
                                <tr class="product-removes">
                                    ...
                                    <td>
                                        <div class="product-names">
                                            <div class="light-product-box"><img class="img-fluid"
                                                    src="{{ asset('assets/images/product/product-categories/wireless-headphone.png') }}"
                                ...
                                <tr class="product-removes">
                                    ...
                                    <td>
                                        <div class="product-names">
                                            <div class="light-product-box"><img class="img-fluid"
                                                    src="{{ asset('assets/images/product/products/1.png') }}"
                                                    alt="chair">
                                            </div>
                                            <p>Wood Chair</p>
                                        </div>
                                ...
                                <tr class="product-removes">
                                    ...
                                    <td>
                                        <div class="product-names">
                                            <div class="light-product-box"><img class="img-fluid"
                                                    src="{{ asset('assets/images/product/product-categories/ipad.png') }}"
                                                    alt="mac laptop"></div>
                                ...
                                <tr class="product-removes">
                                    ...
                                    <td>
                                        <div class="product-names">
                                            <div class="light-product-box"><img class="img-fluid"
                                                    src="{{ asset('assets/images/product/product-categories/mouse.png') }}"
                                                    alt="mouse"></div>
                                    ...
                                    <td>
                                        <div class="rating"><i class="fa fa-star txt-warning"></i><i
                                                class="fa fa-star txt-warning"></i><i class="fa fa-star f-light"></i><i
                                                class="fa fa-star f-light"></i><i class="fa fa-star f-light"></i></div>
                                    </td>
                                    <td>
                                        <div class="product-action"><a href="{{ route('admin.add-product') }}">
                                                <svg>
                                ...
                                <tr class="product-removes">
                                    ...
                                    <td>
                                        <div class="product-names">
                                            <div class="light-product-box"><img class="img-fluid"
                                                    src="{{ asset('assets/images/product/product-categories/dvd.png') }}"
                                                    alt="DVD"></div>
                                            <p>DVD</p>
                                        </div>
                                    </td>
                                ...
                                <tr class="product-removes">
                                    ...
                                    <td>
                                        <div class="product-names">
                                            <div class="light-product-box"><img class="img-fluid"
                                                    src="{{ asset('assets/images/product/product-categories/speaker.png') }}"
                                                    alt="speakers"></div>
                                            <p>Speakers</p>
                                        </div>
                                    </td>
