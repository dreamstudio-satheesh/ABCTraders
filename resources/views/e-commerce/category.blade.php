  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Category</li>
      </ol>
    </nav>
  </div>
</div>
          ...
          <div class="list-product-header">
            <div>
              <div class="light-box"><a data-bs-toggle="collapse" href="#collapseProduct" role="button"
                ...
                class="btn btn-primary" href="#!"><i class="fa fa-plus"></i>Add Category</a>
            </div>
              ...
              <tbody>
                  ...
                  <td>
                    <div class="product-names">
                      <div class="light-product-box"><img class="img-fluid"
                          src="{{ asset('assets/images/product/1.png') }}" alt="t-shirt"></div>
                      <p>T-Shirts</p>
                    </div>
                  </td>
                  <td>
                ...
                <tr class="product-removes">
                  ...
                  <td>
                    <div class="product-names">
                      <div class="light-product-box"><img class="img-fluid"
                          src="{{ asset('assets/images/product/category/1.png') }}" alt="shoes"></div>
                      <p>Shoes</p>
                    </div>
                  </td>
                  <td>
                ...
                <tr class="product-removes">
                  ...
                  <td>
                    <div class="product-names">
                      <div class="light-product-box"><img class="img-fluid"
                          src="{{ asset('assets/images/product/category/2.png') }}" alt="hand bags"></div>
                      <p>Handbags</p>
                    </div>
                  </td>
                  <td>
                ...
                <tr class="product-removes">
                  ...
                  <td>
                    <div class="product-names">
                      <div class="light-product-box"><img class="img-fluid"
                          src="{{ asset('assets/images/product/products/1.png') }}" alt="chairs"></div>
                      <p>Chairs</p>
                    </div>
                  </td>
                  <td>
                ...
                <tr class="product-removes">
                  ...
                  <td>
                    <div class="product-names">
                      <div class="light-product-box"><img class="img-fluid"
                          src="{{ asset('assets/images/product/category/3.png') }}" alt="toys"></div>
                      <p>Toys</p>
                    </div>
                  </td>
                  <td>
                ...
                <tr class="product-removes">
                  ...
                  <td>
                    <div class="product-names">
                      <div class="light-product-box"><img class="img-fluid"
                          src="{{ asset('assets/images/product/category/4.png') }}" alt="slipper"></div>
                      <p>Slipper</p>
                    </div>
                  </td>
                  <td>
                ...
                <tr class="product-removes">
                  ...
                  <td>
                    <div class="product-names">
                      <div class="light-product-box"><img class="img-fluid"
                          src="{{ asset('assets/images/product/category/5.png') }}" alt="camera"></div>
                      <p>Cameras</p>
                    </div>
                  </td>
                  <td>
                ...
                <tr class="product-removes">
                  ...
                  <td>
                    <div class="product-names">
                      <div class="light-product-box"><img class="img-fluid"
                          src="{{ asset('assets/images/product/2.png') }}" alt="t-shirt"></div>
                      <p>T-Shirts</p>
                    </div>
                  </td>
                  <td>
                ...
                <tr class="product-removes">
                  ...
                  <td>
                    <div class="product-names">
                      <div class="light-product-box"><img class="img-fluid"
                          src="{{ asset('assets/images/product/product-categories/watch.png') }}" alt="watch"></div>
                      <p>Watches</p>
                    </div>
                  </td>
                  <td>
                ...
                <tr class="product-removes">
                  ...
                  <td>
                    <div class="product-names">
                      <div class="light-product-box"><img class="img-fluid"
                          src="{{ asset('assets/images/product/12.png') }}" alt="t-shirt"></div>
                      <p>T-Shirts</p>
                    </div>
                  </td>
                  <td>
