  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Contacts</li>
      </ol>
    </nav>
  </div>
</div>
                ...
                <div class="card-body">
                  <div class="email-app-sidebar left-bookmark">
                    ...
                    <ul class="nav main-menu contact-options" role="tablist">
                      <li class="nav-item">
                        <button class="button-primary btn-block btn-mail w-100" type="button" data-bs-toggle="modal"
                          data-bs-target="#exampleModal"><i class="me-2" data-feather="users"></i> New Contacts</button>
                                ...
                                <form class="form-bookmark needs-validation" id="bookmark-form" novalidate="">
                                  <div class="row g-3">
                                    <div class="col-md-12">
                                      ...
                                      <div class="row g-3">
                                        <div class="col-sm-6">
                                          <input class="form-control" id="con-name" type="text" required=""
                                            placeholder="First Name" autocomplete="off">
                                        </div>
                                        <div class="col-sm-6">
                                          <input class="form-control" id="con-last" type="text" required=""
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <input class="form-control" id="con-mail" type="email" required=""
                                        autocomplete="off">
                                    </div>
                                    <div class="col-md-12">
                                      ...
                                      <div class="row g-3">
                                        <div class="col-sm-6">
                                          <input class="form-control" id="con-phone" type="number" required=""
                                            autocomplete="off">
                                        </div>
                                        <div class="col-sm-6">
                                  ...
                                  <button class="btn btn-success" type="submit" onclick="submitContact()">Save</button>
                      ...
                      <li><a id="pills-personal-tab" data-bs-toggle="pill" href="#pills-personal" role="tab"
                          aria-controls="pills-personal" aria-selected="true"><span class="title"> Personal</span></a>
                      </li>
                      <li>
                        <button class="btn btn-category" type="button" data-bs-toggle="modal"
                          data-bs-target="#exampleModal1"><span class="title"> + Add Category</span></button>
                        <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog"
                          aria-labelledby="exampleModalLabel1" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h3 class="modal-title" id="exampleModalLabel1">Add Categories</h3>
                                <button class="btn-close" type="button" data-bs-dismiss="modal"
                                  aria-label="Close"></button>
                              </div>
                              <div class="modal-body">
                      ...
                      <li><a class="show" id="pills-organization-tab" data-bs-toggle="pill" href="#pills-organization"
                          role="tab" aria-controls="pills-organization" aria-selected="false"><span class="title">
                      ...
                      <div class="row list-persons" id="addcon">
                        <div class="col-xl-4 xl-50 col-md-5">
                          <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                            aria-orientation="vertical"><a class="contact-tab-0 nav-link active" id="v-pills-user-tab"
                              data-bs-toggle="pill" onclick="activeDiv(0)" href="#v-pills-user" role="tab"
                              ...
                              <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_0"
                                ...
                                <div class="flex-grow-1">
                                  <h5> <span class="first_name_0">Bucky </span><span class="last_name_0">Barnes</span>
                                  </h5>
                                  <p class="email_add_0">barnes@gmail.com</p>
                                </div>
                              </div>
                            </a><a class="contact-tab-1 nav-link" id="v-pills-profile-tab" data-bs-toggle="pill"
                              onclick="activeDiv(1)" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile"
                              aria-selected="false">
                              <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_1"
                                  src="{{ asset('assets/images/user/8.jpg') }}" alt="">
                                <div class="flex-grow-1">
                                  <h5><span class="first_name_1">Comeren </span><span class="last_name_1">Diaz</span>
                                  </h5>
                                  <p class="email_add_1">comeren@gmail.com</p>
                                </div>
                              </div>
                            </a><a class="contact-tab-2 nav-link" id="v-pills-messages-tab" data-bs-toggle="pill"
                              onclick="activeDiv(2)" href="#v-pills-messages" role="tab"
                              aria-controls="v-pills-messages" aria-selected="false">
                              <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_2"
                            ...
                            </a><a class="contact-tab-3 nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                              onclick="activeDiv(3)" href="#v-pills-settings" role="tab"
                              aria-controls="v-pills-settings" aria-selected="false">
                              <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_3"
                            ...
                            </a><a class="contact-tab-4 nav-link" id="v-pills-contact1-tab" data-bs-toggle="pill"
                              onclick="activeDiv(4)" href="#v-pills-contact1" role="tab"
                              aria-controls="v-pills-settings" aria-selected="false">
                              <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_4"
                                  src="{{ asset('assets/images/user/5.jpg') }}" alt="">
                                <div class="flex-grow-1">
                                  <h5> <span class="first_name_4">Jason </span><span class="last_name_4">Borne</span>
                                  </h5>
                                  <p class="email_add_4">jasonb@gmail.com</p>
                                </div>
                              </div>
                            </a><a class="contact-tab-5 nav-link" id="v-pills-contact8-tab" data-bs-toggle="pill"
                              onclick="activeDiv(5)" href="#v-pills-contact2" role="tab"
                              aria-controls="v-pills-settings" aria-selected="false">
                              <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_5"
                                  src="{{ asset('assets/images/avtar/11.jpg') }}" alt="">
                                <div class="flex-grow-1">
                                  <h5> <span class="first_name_5">Monty </span><span class="last_name_5">Carlo</span>
                                  </h5>
                                  <p class="email_add_5">monty@gmail.com</p>
                                </div>
                              </div>
                            </a><a class="contact-tab-6 nav-link" id="v-pills-contact3-tab" data-bs-toggle="pill"
                              onclick="activeDiv(6)" href="#v-pills-contact3" role="tab"
                              aria-controls="v-pills-settings" aria-selected="false">
                              <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_6"
                          ...
                          <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane contact-tab-0 tab-content-child fade show active" id="v-pills-user"
                              ...
                              <div class="profile-mail">
                                <div class="d-flex"><img class="img-fluid m-r-20 rounded-circle update_img_0"
                                    src="{{ asset('assets/images/user/2.png') }}" alt="">
                                  <input class="updateimg" type="file" name="img" onchange="readURL(this,0)">
                                  <div class="flex-grow-1 mt-0">
                                    <h3><span class="first_name_0">Bucky </span><span class="last_name_0">Barnes</span>
                                    </h3>
                                    <p class="email_add_0">barnes@gmail.com</p>
                                    <ul>
                                ...
                                <div class="email-general">
                                  ...
                                  <ul>
                                    ...
                                    <li>Birthday<span class="font-primary"> <span class="birth_day_0">18</span><span
                                          ...
                                          class="birth_year_0 ms-1">2024</span></span></li>
                                    ...
                                    <li>Email Address <span class="font-primary email_add_0">barn@gmail.com </span></li>
                            ...
                            <div class="tab-pane contact-tab-1 tab-content-child fade" id="v-pills-profile"
                              role="tabpanel" aria-labelledby="v-pills-profile-tab">
                              <div class="profile-mail">
                                <div class="d-flex"><img class="img-fluid m-r-20 rounded-circle update_img_1"
                                    src="{{ asset('assets/images/user/8.jpg') }}" alt="">
                                  <input class="updateimg" type="file" name="img" onchange="readURL(this,1)">
                                  <div class="flex-grow-1 mt-0">
                                    <h3><span class="first_name_1">Comeren </span><span class="last_name_1">Diaz</span>
                                    </h3>
                                    <p class="email_add_1">come@gmail.com</p>
                                    <ul>
                                      ...
                                      <li><a href="#" onclick="printContact(1)" data-bs-toggle="modal"
                                          data-bs-target="#printModal">Print</a></li>
                                    </ul>
                                  </div>
                                </div>
                                <div class="email-general">
                                  ...
                                  <ul>
                                    ...
                                    <li>Birthday<span class="font-primary"> <span class="birth_day_1">7</span><span
                                          class="birth_month_1 ms-1">Feb</span><span
                                          class="birth_year_1 ms-1">1995</span></span></li>
                                    ...
                                    <li>Email Address <span class="font-primary email_add_1">comeren@gmail.com</span>
                                    </li>
                            ...
                            <div class="tab-pane contact-tab-2 tab-content-child fade" id="v-pills-messages"
                              role="tabpanel" aria-labelledby="v-pills-messages-tab">
                              <div class="profile-mail">
                                <div class="d-flex"><img class="img-fluid m-r-20 rounded-circle update_img_2"
                                    src="{{ asset('assets/images/user/1.jpg') }}" alt="">
                                  <input class="updateimg" type="file" name="img" onchange="readURL(this,2)">
                                  <div class="flex-grow-1 mt-0">
                                    <h3> <span class="first_name_2">Issa </span><span class="last_name_2">Bell</span>
                                    </h3>
                                    <p class="email_add_2">issa@gmail.com</p>
                                    <ul>
                                      ...
                                      <li><a href="#" onclick="printContact(2)" data-bs-toggle="modal"
                                          data-bs-target="#printModal">Print</a></li>
                                    </ul>
                                  </div>
                                </div>
                                <div class="email-general">
                                  ...
                                  <ul>
                                    ...
                                    <li>Gender <span class="font-primary">Male</span></li>
                                    <li>Birthday<span class="font-primary"> <span class="birth_day_2">20</span><span
                                          class="birth_month_2 ms-1">Jul</span><span
                                          class="birth_year_2 ms-1">1993</span></span></li>
                                    ...
                                    <li>Email Address <span class="font-primary email_add_2">issabell@gmail.com</span>
                                    </li>
                            ...
                            <div class="tab-pane contact-tab-3 tab-content-child fade" id="v-pills-settings"
                              role="tabpanel" aria-labelledby="v-pills-settings-tab">
                              <div class="profile-mail">
                                <div class="d-flex"><img class="img-fluid m-r-20 rounded-circle update_img_3"
                                    src="{{ asset('assets/images/user/14.png') }}" alt="">
                                  <input class="updateimg" type="file" name="img" onchange="readURL(this,3)">
                                  <div class="flex-grow-1 mt-0">
                                    <h3> <span class="first_name_3">Andew </span><span class="last_name_3">Jon</span>
                                    </h3>
                                    <p class="email_add_3">andew@gmail.com</p>
                                    <ul>
                                      ...
                                      <li><a href="#" onclick="printContact(3)" data-bs-toggle="modal"
                                          data-bs-target="#printModal">Print</a></li>
                                    </ul>
                                  </div>
                                </div>
                                <div class="email-general">
                                  ...
                                  <ul>
                                    ...
                                    <li>Gender <span class="font-primary">Male</span></li>
                                    <li>Birthday<span class="font-primary"> <span class="birth_day_3">25</span><span
                                          class="birth_month_3 ms-1">Aug</span><span
                                          class="birth_year_3 ms-1">1996</span></span></li>
                                    ...
                                    <li>Email Address <span class="font-primary email_add_3">andewjon@gmail.com</span>
                                    </li>
                            ...
                            <div class="tab-pane contact-tab-4 tab-content-child fade" id="v-pills-contact1"
                              role="tabpanel" aria-labelledby="v-pills-contact1-tab">
                              <div class="profile-mail">
                                <div class="d-flex"><img class="img-fluid m-r-20 rounded-circle update_img_4"
                                    src="{{ asset('assets/images/user/5.jpg') }}" alt="">
                                  <input class="updateimg" type="file" name="img" onchange="readURL(this,4)">
                                  <div class="flex-grow-1 mt-0">
                                    <h3> <span class="first_name_4">Jason </span><span class="last_name_4">Borne</span>
                                    </h3>
                                    <p class="email_add_4">jason@gmail.com</p>
                                    <ul>
                                      ...
                                      <li><a href="#" onclick="printContact(4)" data-bs-toggle="modal"
                                          data-bs-target="#printModal">Print</a></li>
                                    </ul>
                                  </div>
                                </div>
                                <div class="email-general">
                                  ...
                                  <ul>
                                    ...
                                    <li>Gender <span class="font-primary">Male</span></li>
                                    <li>Birthday<span class="font-primary"> <span class="birth_day_4">30</span><span
                                          class="birth_month_4 ms-1">Oct</span><span
                                          class="birth_year_4 ms-1">1992</span></span></li>
                                    ...
                                    <li>Email Address <span class="font-primary email_add_4">jasonb@gmail.com</span>
                                    </li>
                            ...
                            <div class="tab-pane contact-tab-5 tab-content-child fade" id="v-pills-contact8"
                              role="tabpanel" aria-labelledby="v-pills-contact1-tab">
                              <div class="profile-mail">
                                <div class="d-flex"><img class="img-fluid m-r-20 rounded-circle update_img_5"
                                    src="{{ asset('assets/images/avtar/11.jpg') }}" alt="">
                                  <input class="updateimg" type="file" name="img" onchange="readURL(this,5)">
                                  <div class="flex-grow-1 mt-0">
                                    <h3> <span class="first_name_5">Monty </span><span class="last_name_5">Carlo</span>
                                    </h3>
                                    <p class="email_add_5">monty@gmail.com</p>
                                    <ul>
                                      ...
                                      <li><a href="#" onclick="printContact(5)" data-bs-toggle="modal"
                                          data-bs-target="#printModal">Print</a></li>
                                    </ul>
                                  </div>
                                </div>
                                <div class="email-general">
                                  ...
                                  <ul>
                                    ...
                                    <li>Gender <span class="font-primary">Male</span></li>
                                    <li>Birthday<span class="font-primary"> <span class="birth_day_5">12</span><span
                                          class="birth_month_5 ms-1">Nov</span><span
                                          class="birth_year_5 ms-1">1994</span></span></li>
                            ...
                            <div class="tab-pane contact-tab-6 tab-content-child fade" id="v-pills-contact9"
                              role="tabpanel" aria-labelledby="v-pills-contact8-tab">
                              <div class="profile-mail">
                                <div class="d-flex"><img class="img-fluid m-r-20 rounded-circle update_img_6"
                                    src="{{ asset('assets/images/avtar/16.jpg') }}" alt="">
                                  <input class="updateimg" type="file" name="img" onchange="readURL(this,6)">
                                  <div class="flex-grow-1 mt-0">
                                    <h3> <span class="first_name_6">Brock </span><span class="last_name_6">Lee</span>
                                    </h3>
                                    <p class="email_add_6">lee@gmail.com</p>
                                    <ul>
                                      ...
                                      <li><a href="#" onclick="printContact(6)" data-bs-toggle="modal"
                                          data-bs-target="#printModal">Print</a></li>
                                    </ul>
                                  </div>
                                </div>
                                <div class="email-general">
                                  ...
                                  <ul>
                                    ...
                                    <li>Gender <span class="font-primary">Male</span></li>
                                    <li>Birthday<span class="font-primary"> <span class="birth_day_6">8</span><span
                                          class="birth_month_6 ms-1">Dec</span><span
                                          class="birth_year_6 ms-1">1992</span></span></li>
                            ...
                            <form>
                              <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="row g-3">
                                    <div class="col-sm-6">
                                      <input class="form-control" id="mobile_num" type="number" required=""
                                        autocomplete="off">
                                    </div>
                                    <div class="col-sm-6">
                              ...
                              <div class="row g-3 more-data mt-2">
                                <div class="col-md-12">
                                  <label>URLS</label>
                                  <div class="row g-3">
                                    <div class="col-sm-6">
                                ...
                                <div class="col-md-12">
                                  <div class="row g-3">
                                    <div class="col-sm-6">
                                      ...
                                      <input class="form-control" id="personality" type="text" required=""
                                        autocomplete="off">
                                    </div>
                                    <div class="col-sm-6">
                                      <label>Interest</label>
                                      <input class="form-control" id="interest" type="number" required=""
                                        autocomplete="off">
                                    </div>
                                  </div>
                                </div>
                              ...
                              <button class="btn btn-success update-contact" type="button">Save</button>
                              <button class="btn btn-primary" type="button" data-bs-dismiss="modal">Cancel</button>
                            </form>
                          </div>
                        </div>
                      ...
                      <div class="row list-persons">
                        <div class="col-xl-4 xl-50 col-md-5">
                          <div class="nav flex-column nav-pills" id="v-pills-tab1" role="tablist"
                            aria-orientation="vertical"><a class="nav-link active" id="v-pills-iduser-tab"
                              data-bs-toggle="pill" href="#v-pills-iduser" role="tab" aria-controls="v-pills-iduser"
                              aria-selected="true">
                              ...
                              href="#v-pills-iduser1" role="tab" aria-controls="v-pills-iduser1" aria-selected="false">
                              <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle"
                              ...
                              href="#v-pills-iduser2" role="tab" aria-controls="v-pills-iduser2" aria-selected="false">
                              <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle"
                              ...
                              href="#v-pills-iduser3" role="tab" aria-controls="v-pills-iduser3" aria-selected="false">
                              <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle"
                        ...
                        <div class="col-xl-8 xl-50 col-md-7">
                          <div class="tab-content" id="v-pills-tabContent1">
                            <div class="tab-pane fade show active" id="v-pills-iduser" role="tabpanel"
                              aria-labelledby="v-pills-iduser-tab">
                              <div class="profile-mail">
                            ...
                            <div class="tab-pane fade" id="v-pills-iduser1" role="tabpanel"
                              ...
                              <div class="profile-mail">
                                <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_6"
                                    src="{{ asset('assets/images/user/3.jpg') }}" alt="">
                                  <div class="flex-grow-1 mt-0">
                            ...
                            <div class="tab-pane fade" id="v-pills-iduser2" role="tabpanel"
                              ...
                              <div class="profile-mail">
                                <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_7"
                                    src="{{ asset('assets/images/user/4.jpg') }}" alt="">
                                  <div class="flex-grow-1 mt-0">
                                    ...
                                    <ul>
                                      <li><a href="#" onclick="printContact(7)" data-bs-toggle="modal"
                                          data-bs-target="#printModal">Print</a></li>
                                    </ul>
                                  </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-iduser3" role="tabpanel"
                              ...
                              <div class="profile-mail">
                                <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_8"
                                    src="{{ asset('assets/images/user/10.jpg') }}" alt="">
                                  <div class="flex-grow-1 mt-0">
                                    ...
                                    <ul>
                                      <li><a href="#" onclick="printContact(8)" data-bs-toggle="modal"
                                          data-bs-target="#printModal">Print</a></li>
                                    </ul>
                                  </div>
                                </div>
                ...
                <div id="right-history">
                  <div class="modal-header p-20">
                    <h3 class="modal-title w-100">Contact History<span class="pull-right"><a class="closehistory"
                          href="#"><i class="icofont icofont-close"></i></a></span></h3>
                  </div>
                  <div class="history-details">
                    <div class="text-center"><i class="icofont icofont-ui-edit"></i>
                      <p>Contact has not been modified yet.</p>
                    </div>
                    <div class="d-flex gap-2"><i class="icofont icofont-star"></i>
                      <div class="flex-grow-1 mt-0">
                        <h6 class="mt-0">Contact Created</h6>
                        <p class="mb-0">Contact is created via mail</p><span class="f-12">Sep 10, 2024 4:00</span>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body list-persons">
                        <div class="profile-mail pt-0" id="DivIdToPrint">
                          <div class="common-flex align-items-center"><img class="img-fluid rounded-circle"
                              id="updateimg" src="{{ asset('assets/images/user/2.png') }}" alt="">
                            <div class="flex-grow-1 mt-0">
                              <h4><span id="printname">Bucky </span><span id="printlast">Barnes</span></h4>
                        ...
                        <button class="btn btn-success" id="btnPrint" type="button" onclick="printDiv();">Print</button>
                        <button class="btn btn-primary" type="button" data-bs-dismiss="modal">Cancel</button>
                      </div>
                    </div>
                  </div>
