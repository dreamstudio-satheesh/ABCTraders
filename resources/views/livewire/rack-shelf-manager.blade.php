                    ...
                    <form wire:submit.prevent="{{ $rackId ? 'updateRack' : 'createRack' }}">
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="number" id="defaultShelfCapacity" class="form-control"
                                    wire:model="defaultShelfCapacity">
                                @error('defaultShelfCapacity')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="d-flex">
                                ...
                                @if ($rackId)
                                    <button type="button" class="btn btn-secondary"
                                        wire:click="resetRackInput">Cancel</button>
                                @endif
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-info me-1"
                                                wire:click="selectRack({{ $rack->id }})">
                                                Manage Shelves
                                            </button>
                                            <button class="btn btn-sm btn-warning me-1"
                                                wire:click="editRack({{ $rack->id }})">
                                                Edit
                                            </button>
                                            <button class="btn btn-sm btn-danger"
                                                wire:click="deleteRack({{ $rack->id }})"
                    ...
                    <div class="card-body">
                        ...
                        <form wire:submit.prevent="{{ $shelfId ? 'updateShelf' : 'createShelf' }}">
                            ...
                            <div class="d-flex">
                                ...
                                @if ($shelfId)
                                    <button type="button" class="btn btn-secondary"
                                        wire:click="resetShelfInput">Cancel</button>
                                @endif
                            </div>
                        </form>
                        <hr>
                                ...
                                <tbody>
                                    @forelse($allShelves as $shelf)
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-warning me-1"
                                                    wire:click="editShelf({{ $shelf->id }})">
                                                    Edit
                                                </button>
                                                <button class="btn btn-sm btn-danger"
                                                    wire:click="deleteShelf({{ $shelf->id }})"
                                                    onclick="confirm('Are you sure?') || event.stopImmediatePropagation()">
                                                    Delete
                                                </button>
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="text-center">No shelves found for this rack.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
