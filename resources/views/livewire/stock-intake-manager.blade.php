                        ...
                        <table class="table table-bordered align-middle">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 15%;">Intake Date</th>
                            ...
                            <tbody>
                                @forelse($allStockIntakes as $intake)
                                    <tr>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($intake->intake_date)->diffForHumans() }}</td>
                                        <td>
                                            <button class="btn btn-sm btn-warning me-1"
                                                wire:click="editStockIntake({{ $intake->id }})">
                                                <i class="fa fa-edit"></i>
                                            </button>
                                            <button class="btn btn-sm btn-danger"
                                                wire:click="deleteStockIntake({{ $intake->id }})"
