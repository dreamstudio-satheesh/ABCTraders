    ...
    <div>
        ...
        <nav>
            <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
                ...
                <li class="breadcrumb-item f-w-500">Chats</li>
                <li class="breadcrumb-item f-w-500 active">Group Chat</li>
            </ol>
        </nav>
    </div>
</div>
                    ...
                    <div class="common-space">
                        <div class="chat-time group-chat">
                            <ul>
                                ...
                                <li><img class="img-fluid rounded-circle" src="{{ asset('assets/images/avtar/4.jpg') }}"
                                        alt="user"></li>
                                <li><img class="img-fluid rounded-circle" src="{{ asset('assets/images/avtar/7.jpg') }}"
                                        alt="user"></li>
                                <li><img class="img-fluid rounded-circle"
                                        src="{{ asset('assets/images/avtar/11.jpg') }}" alt="user"></li>
                                <li><img class="img-fluid rounded-circle" src="{{ asset('assets/images/avtar/4.jpg') }}"
                                        alt="user"></li>
                                <li><img class="img-fluid rounded-circle"
...
<script src="{{ asset('assets/js/emoji-js/uikit.min.js') }}"></script>
