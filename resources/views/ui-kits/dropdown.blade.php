  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Dropdown</li>
      </ol>
    </nav>
  </div>
</div>
      ...
      <div class="card title-line">
        ...
        <div class="card-body rtl-dropdown">
          <div class="common-flex">
            ...
            <div class="btn-group">
              <button class="btn btn-warning text-black dropdown-toggle" type="button" data-bs-toggle="dropdown"
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#basic-dropdown" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="basic-dropdown">&lt;!--You can use .dropdown-menu and inside added .dropdown-item.*(dropdown list)--&gt;
&lt;div class="btn-group"&gt;
    ...
    <div class="col-xl-6">
      <div class="card title-line">
        <div class="card-header">
          ...
          <p class="f-m-light mt-2">When the <code>.show</code> class starts, dropdown appears and
        ...
        <div class="card-body rtl-dropdown">
          <div class="common-flex">
            ...
            <div class="btn-group">
              <button class="btn btn-info rounded-pill dropdown-toggle" type="button" data-bs-toggle="dropdown"
            ...
            <div class="btn-group">
              <button class="btn btn-warning rounded-pill dropdown-toggle" type="button" data-bs-toggle="dropdown"
            ...
            <div class="btn-group">
              <button class="btn btn-danger rounded-pill dropdown-toggle" type="button" data-bs-toggle="dropdown"
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#rounded-dropdown" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="rounded-dropdown">&lt;!--You can use .dropdown-menu and inside added .dropdown-item.*(dropdown list)--&gt;
&lt;div class="btn-group"&gt;
          ...
          <div class="common-flex">
            ...
            <div class="btn-group">
              ...
              <div class="dropdown separated-btn">
                ...
                <div class="dropdown-content"><a href="#!">Echarts</a><a href="#!">Apex chart</a></div>
              </div>
            </div>
            <div class="btn-group">
            ...
            <div class="btn-group">
              ...
              <div class="dropdown separated-btn">
                ...
                <div class="dropdown-content"><a href="#!">Flag icons </a><a href="#!">Fontawesome icons </a><a
                    href="#!">Ico icons</a><a href="#!">Feather icons </a></div>
              </div>
            </div>
            <div class="btn-group">
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#split-dropdown" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="split-dropdown">&lt;!--You can use .dropdown-menu and inside added .dropdown-item.*(dropdown list)--&gt;
&lt;div class="btn-group"&gt;
&lt;button class="btn btn-outline-primary" type="button"&gt;Widgets&lt;/button&gt;
&lt;div class="dropdown separated-btn"&gt;
&lt;button class="btn btn-primary" type="button"&gt;&lt;i class="icofont icofont-arrow-down"&gt;&lt;/i&gt;&lt;/button&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-4 col-sm-6">
      <div class="card height-equal title-line">
        <div class="card-header">
          <h2> Heading dropdown</h2>
          <p class="f-m-light mt-2">Main heading and any sub-content in dropdown.</p>
          <div class="card-header-right">
            <ul class="list-unstyled card-option">
              <li><i class="fa fa-spin fa-cog"></i></li>
              <li><i class="view-html fa fa-code"></i></li>
        ...
        <div class="card-body rtl-dropdown heading-dropdown">
          <div class="common-flex">
            <div class="btn-group">
              <button class="btn btn-success rounded-pill dropdown-toggle" type="button" data-bs-toggle="dropdown"
                aria-expanded="false">Party</button>
              <ul class="dropdown-menu dropdown-block">
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#heading-dropdown" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="heading-dropdown">&lt;!--You can use .dropdown-menu and inside added .dropdown-item.*(dropdown list)--&gt;
&lt;div class="btn-group"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-4 col-sm-6">
      <div class="card height-equal title-line">
        <div class="card-header">
          <h2> With input type</h2>
          <p class="f-m-light mt-2">Use the checkbox using dropdown<code>(type='checkbox'/'radio')</code>.</p>
          <div class="card-header-right">
            <ul class="list-unstyled card-option">
              <li><i class="fa fa-spin fa-cog"></i></li>
              <li><i class="view-html fa fa-code"></i></li>
        ...
        <div class="card-body">
          <div class="common-flex">
            <btn-group>
              <button class="btn btn-warning" type="button" data-bs-toggle="dropdown" aria-expanded="false">Inputs
              </button>
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#input-type-dropdown"
                title="Copy"><i class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="input-type-dropdown">&lt;!--You can use .dropdown-menu and inside added .dropdown-item.*(dropdown list)--&gt;
&lt;btn-group&gt;
...
&lt;/btn-group&gt;</code></pre>
    ...
    <div class="col-xl-4 col-sm-6">
      <div class="card height-equal title-line">
        <div class="card-header">
          <h2> Dark dropdown</h2>
          <p class="f-m-light mt-2"><code>.dropdown-menu-dark</code> class through make dark mode.</p>
          <div class="card-header-right">
            <ul class="list-unstyled card-option">
              <li><i class="fa fa-spin fa-cog"></i></li>
              <li><i class="view-html fa fa-code"></i></li>
        ...
        <div class="card-body dropdown-basic m-0 rtl-dropdown">
          <div class="common-flex dark-dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark dropdown-block rounded-0">
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#dark-dropdown" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="dark-dropdown">&lt;!--You can use .dropdown-menu and inside added .dropdown-item.*(dropdown list)--&gt;
...
&lt;/ul&gt;</code></pre>
    ...
    <div class="col-sm-6">
      <div class="card title-line">
        <div class="card-header">
          <h2>Unique dropdown</h2>
          <p class="f-m-light mt-2">Unique way to represent form dropdown and text dropdown.</p>
          <div class="card-header-right">
            <ul class="list-unstyled card-option">
              <li><i class="fa fa-spin fa-cog"></i></li>
              <li><i class="view-html fa fa-code"></i></li>
        ...
        <div class="card-body rtl-dropdown">
          <div class="common-flex">
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#unique-dropdown" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="unique-dropdown">&lt;!--You can use .dropdown-menu and inside added .dropdown-item.*(dropdown list)--&gt;
&lt;div class="btn-group"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-lg-6">
      <div class="card title-line">
        <div class="card-header">
          <h2> Justify contents</h2>
          <p class="f-m-light mt-2">Use the <code>(text-start/text-center/text-end)</code> to change dropdown texts.</p>
          <div class="card-header-right">
            <ul class="list-unstyled card-option">
              <li><i class="fa fa-spin fa-cog"></i></li>
              <li><i class="view-html fa fa-code"></i></li>
        ...
        <div class="card-body dropdown-basic m-0">
          <div class="common-flex">
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#justify-dropdown" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="justify-dropdown">&lt;!--You can use .dropdown-menu and inside added .dropdown-item.*(dropdown list)--&gt;
&lt;div class="common-flex"&gt;
&lt;div class="btn-group"&gt;
...
&lt;/div&gt;
&lt;div class="btn-group"&gt;
&lt;button class="btn btn-warning dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"&gt;Text-center&lt;/button&gt;
&lt;ul class="dropdown-menu dropdown-block text-center"&gt;
&lt;li&gt;&lt;a class="dropdown-item" href="#!"&gt;Chocolate&lt;/a&gt;&lt;/li&gt;
&lt;li&gt;&lt;a class="dropdown-item" href="#!"&gt;Ice-cream&lt;/a&gt;&lt;/li&gt;
&lt;li&gt;&lt;a class="dropdown-item" href="#!"&gt;Trophy&lt;/a&gt;&lt;/li&gt;
...
&lt;/div&gt;
&lt;div class="btn-group"&gt;
&lt;button class="btn btn-success dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"&gt;Text-right &lt;/button&gt;
&lt;ul class="dropdown-menu dropdown-block text-end"&gt;
&lt;li&gt;&lt;a class="dropdown-item" href="#!"&gt;I'm fine.&lt;/a&gt;&lt;/li&gt;
&lt;li&gt;&lt;a class="dropdown-item" href="#!"&gt;ohh wow!!&lt;/a&gt;&lt;/li&gt;
&lt;li&gt;&lt;a class="dropdown-item" href="#!"&gt;That's the good news! &lt;/a&gt;&lt;/li&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-lg-6">
      <div class="card title-line">
        <div class="card-header">
          <h2> Alignments</h2>
          <p class="f-m-light mt-2">Use the <code>(dropstart/dropup/dropend)</code> this class through change dropdown
            directions.</p>
          <div class="card-header-right">
            <ul class="list-unstyled card-option">
              <li><i class="fa fa-spin fa-cog"></i></li>
        ...
        <div class="card-body rtl-dropdown">
          <div class="common-flex">
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#alignment-dropdown"
                title="Copy"><i class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="alignment-dropdown">&lt;!--You can use .dropdown-menu and inside added .dropdown-item.*(dropdown list)--&gt;
&lt;div class="btn-group dropup"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
      <div class="card title-line">
        <div class="card-header">
          <h2>Helper card</h2>
          <p class="f-m-light mt-2">When the <code>.show</code> class starts, dropdown appears.</p>
          <div class="card-header-right">
            <ul class="list-unstyled card-option">
              <li><i class="fa fa-spin fa-cog"></i></li>
              <li><i class="view-html fa fa-code"></i></li>
        ...
        <div class="card-body rtl-dropdown">
          <div class="common-flex">
            <div class="btn-group">
              <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown"
                aria-expanded="false">Helper Card</button>
              <ul class="dropdown-menu dropdown-block p-3 dark-form">
                <li>
                  <h6 class="fs-6 pb-2">Learn More!</h6>
                  <p class="dropdown-item helper-truncate">There is a lot of information available here</p>
                </li>
              </ul>
            </div>
            <div class="btn-group">
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#helper-dropdown" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="helper-dropdown">&lt;!--You can use .dropdown-menu and inside added .dropdown-item.*(dropdown list)--&gt;
&lt;div class="btn-group"&gt;
      ...
      <div class="card height-equal title-line">
        ...
        <div class="card-body rtl-dropdown">
          <div class="common-flex">
            <div class="btn-group">
              <button class="btn btn-success rounded-pill dropdown-toggle" type="button" data-bs-toggle="dropdown"
                aria-expanded="false">Wishlist</button>
              <ul class="dropdown-menu dropdown-block">
            ...
            <div class="btn-group">
              <button class="btn btn-primary rounded-pill dropdown-toggle" type="button" data-bs-toggle="dropdown"
                aria-expanded="false">Sports </button>
              <ul class="dropdown-menu dropdown-block">
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#divider-dropdown" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="divider-dropdown">&lt;!--You can use .dropdown-menu and inside added .dropdown-item.*(dropdown list)--&gt;
&lt;div class="btn-group"&gt;
    ...
    <div class="col-md-6">
      <div class="card height-equal title-line">
        ...
        <div class="card-body rtl-dropdown">
          <div class="common-flex">
            <div class="btn-group">
              <button class="btn btn-info light btn-lg dropdown-toggle" type="button" data-bs-toggle="dropdown"
                aria-expanded="false">Large button </button>
              <ul class="dropdown-menu dropdown-block">
            ...
            <div class="btn-group">
              <button class="btn btn-dark light btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown"
                aria-expanded="false">Small button </button>
              <ul class="dropdown-menu dropdown-block">
                <li><a class="dropdown-item" href="#!">Small button </a></li>
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#size-dropdown" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="size-dropdown">&lt;!--You can use .dropdown-menu and inside added .dropdown-item.*(dropdown list)--&gt;
&lt;div class="btn-group"&gt;
