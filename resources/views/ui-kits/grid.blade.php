  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Grid</li>
      </ol>
    </nav>
  </div>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Grid options</h2>
          <p class="mt-2 f-m-light"></p>Bootstrap grid system allow all six breakpoints, and any breakpoints
          you can customize.
        </div>
        <div class="card-body">
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Grid for column</h2>
          <p class="mt-2 f-m-light">You may use predefined grid classes. Using <code>.col-md-* </code>you can set the
            grid system.</p>
        </div>
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          ...
          <p class="mt-2 f-m-light">You can use the <code>align-items-*</code> class
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          ...
          <p class="mt-2 f-m-light">You can use the <code>justify-content-*</code> class
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Nesting</h2>
          <p class="mt-2 f-m-light">To nest your content with the default grid, add a new<code>.row</code> and set
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Order</h2>
          <p class="mt-2 f-m-light">Using <code>.order </code>class, you can set the order position.</p>
        </div>
        <div class="card-body grid-showcase">
          <div class="row g-2">
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Offset</h2>
          <p class="mt-2 f-m-light">You can offset the grid column using <code>.offset-*</code> grid class.</p>
        </div>
        <div class="card-body grid-showcase">
          <div class="row g-2">
