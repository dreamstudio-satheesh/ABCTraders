  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Typography</li>
      </ol>
    </nav>
  </div>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-xxl-6">
      <div class="card height-equal title-line">
        <div class="card-header">
          <h2 class="mb-0">Headings</h2>
          <p class="f-m-light mt-2">All HTML headings <code>&lt;h1&gt;</code> through <code>&lt;h6&gt; </code>are
            available.</p>
        </div>
        <div class="card-body">
    ...
    <div class="col-xxl-6">
      <div class="card height-equal title-line">
        <div class="card-header">
          <h2 class="mb-0">Colored headings</h2>
          <p class="f-m-light mt-2">All HTML headings <code>&lt;h1&gt;</code> through <code>&lt;h6&gt; </code>are
            available.</p>
        </div>
        <div class="card-body">
    ...
    <div class="col-12">
      <div class="card title-line">
        <div class="card-header">
          <h2 class="mb-0">Font weight</h2>
          <p class="f-m-light mt-2">Using <code>f-w-*</code> class, you can change the font weight.</p>
        </div>
    ...
    <div class="col-sm-12 listing">
      <div class="card title-line">
        <div class="card-header">
          <h2 class="mb-0">Listing typography</h2>
          <p class="f-m-light mt-2">All typography list:- <code>&lt;ul&gt;</code>,<code>&lt;ol&gt;</code> &amp;
            <code>&lt;dl&gt;</code>.
          </p>
        </div>
        <div class="card-body">
          <div class="row g-3">
            <div class="col-md-6 col-xxl-4">
              <div class="card-wrapper border rounded-3 bg-primary-light">
                <h6 class="sub-title fw-bold">Unordered list</h6>
                <ul>
                  ...
                  <li>creates more sophisticated capabilities for a web page to use coding language.</li>
            ...
            <div class="col-md-6 col-xxl-4">
              <div class="card-wrapper border rounded-3 h-100 bg-warning-light">
                <h2 class="sub-title fw-bold">Order list</h2>
                <ol>
                  <li>UI Kits</li>
                  <li>Bonus Ui</li>
                  <li>Animations</li>
            ...
            <div class="col-md-12 col-xxl-4">
              <div class="card-wrapper border rounded-3 bg-success-light h-100">
    ...
    <div class="col-12">
      <div class="card title-line">
        <div class="card-header">
          <h2 class="mb-0">Display headings</h2>
    ...
    <div class="col-sm-12 col-xl-6">
      <div class="card title-line">
        <div class="card-header">
          ...
          <p class="f-m-light mt-2">Styling for common inline HTML5 elements.</p>
        </div>
        <div class="card-body">
    ...
    <div class="col-sm-12 col-xl-6">
      <div class="card title-line text-color-card">
        <div class="card-header">
          <h2 class="mb-0">Text color</h2>
          <p class="f-m-light mt-2">You can give text color by using <code>txt-*</code> class</p>
        </div>
        <div class="card-body">
          <div class="d-flex flex-column gap-2">
            <p class="txt-primary mb-0">This is Primary text You can archive this adding<code>.txt-primary</code> class
            </p>
            <p class="txt-secondary mb-0">This is Secondary text You can archive this adding<code>.txt-secondary</code>
              class</p>
            <p class="txt-success mb-0">This is Success text You can archive this adding<code>.txt-success</code> class
            </p>
            <p class="txt-info mb-0">This is Info text You can archive this adding<code>.txt-info</code> class</p>
            <p class="txt-warning mb-0">This is Warning text You can archive this adding<code>.txt-warning</code> class
            </p>
            <p class="txt-danger mb-0">This is Danger text You can archive this adding<code>.txt-danger</code> class</p>
            <p class="txt-dark mb-0">This is Dark text You can archive this adding<code>.txt-dark</code> class</p>
            <p class="txt-primary mb-0">This is Primary text You can archive this adding<code>.txt-primary</code> class
            </p>
          </div>
        </div>
    ...
    <div class="col-sm-12">
      <div class="card overflow-hidden title-line">
        <div class="card-header">
          <h2 class="mb-0">Blockquotes</h2>
          <p class="f-m-light mt-2">The <code>&lt;blockquote&gt;</code> tag specifies a section that is quoted from
            another source.</p>
        </div>
        <div class="card-body">
          <div class="figure d-block dark-blockquote">
            <blockquote class="blockquote light-card bg-light-primary">
          ...
          <div class="figure text-center d-block dark-blockquote">
            <blockquote class="blockquote light-card bg-light-warning">
              <p class="mb-0 txt-dark">In this life we cannot do great things. We can only do small things with great
                love.</p><span class="blockquote-footer pt-3">Mother Teresa</span>
            </blockquote>
          </div>
          <div class="figure text-end d-block dark-blockquote">
            <blockquote class="blockquote light-card bg-light-success">
