  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Tag &amp; Pills</li>
      </ol>
    </nav>
  </div>
</div>
      ...
      <div class="card title-line">
        ...
        <div class="card-body">
          <div class="badge-spacing"><span class="badge badge-primary">Primary</span><span
              class="badge badge-secondary">Secondary</span><span class="badge badge-success">Success</span><span
              class="badge badge-info">Info</span><span class="badge badge-warning text-dark">Warning</span><span
              class="badge badge-danger">Danger</span><span class="badge badge-light text-dark">Light</span><span
              class="badge badge-dark">Dark</span>
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#badge-variations" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="badge-variations">&lt;!--You can use badge-* class through change the colors of badges (primary/secondary/success...).--&gt;
      ...
      <div class="card title-line">
        ...
        <div class="card-body">
          <div class="badge-spacing"><span class="badge rounded-pill badge-primary">Primary</span><span
              ...
              class="badge rounded-pill badge-dark">Dark</span>
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#pills-variations" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="pills-variations">&lt;!--You can use .rounded-pill class through change the rounded badges (rounded-pill).--&gt;
...
&lt;span class="badge rounded-pill badge-dark"&gt;Dark&lt;/span&gt;</code></pre>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-sm-12 col-xl-6">
      <div class="card title-line">
        ...
        <div class="card-body">
          <div class="badge-spacing"><a class="badge badge-primary" href="#!">1</a><a class="badge badge-secondary"
              href="#!">2</a><a class="badge badge-success" href="#!">3</a><a class="badge badge-info" href="#!">4</a><a
              class="badge badge-warning text-dark" href="#!">5</a><a class="badge badge-danger" href="#!">6</a><a
              class="badge badge-light text-dark" href="#!">7</a><a class="badge badge-dark" href="#!">8</a>
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#number-of-badge" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="number-of-badge">&lt;!--You can use badge-* class through make badges (Numbered Badges).--&gt;
...
&lt;a class="badge badge-dark" href="#!"&gt;8&lt;/a&gt;</code></pre>
    ...
    <div class="col-sm-12 col-xl-6">
      <div class="card title-line">
        ...
        <div class="card-body">
          <div class="badge-spacing"><span class="badge rounded-circle badge-p-space badge-primary">1</span><span
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#number-of-pills" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="number-of-pills">&lt;!--You can use .rounded-circle class through change the circled badges (rounded-circle).--&gt;
      ...
      <div class="card title-line">
        ...
        <div class="card-body">
          <div class="badge-spacing"><a class="badge b-ln-height badge-primary" href="#!"><i
                data-feather="dollar-sign"></i></a><a class="badge b-ln-height badge-secondary" href="#!"><i
                data-feather="headphones"></i></a><a class="badge b-ln-height badge-success" href="#!"><i
                data-feather="link"></i></a><a class="badge b-ln-height badge-info" href="#!"><i
                data-feather="github"></i></a><a class="badge b-ln-height badge-warning text-dark" href="#!"><i
                data-feather="award"></i></a><a class="badge b-ln-height badge-danger" href="#!"><i
                data-feather="activity"></i></a><a class="badge b-ln-height badge-light text-dark" href="#!"><i
                data-feather="heart"></i></a><a class="badge badge-dark" href="#!"><i data-feather="mail"></i></a>
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#badge-icons" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre class="custom-scrollbar"><code class="language-html" id="badge-icons">&lt;!--You can use data-feather icons through change the icons badges.--&gt;
      ...
      <div class="card title-line">
        ...
        <div class="card-body">
          <div class="badge-spacing"><a class="badge rounded-circle p-2 badge-primary" href="#!"><i
                data-feather="dollar-sign"></i></a><a class="badge rounded-circle p-2 badge-secondary" href="#!"><i
                data-feather="headphones"></i></a><a class="badge rounded-circle p-2 badge-success" href="#!"><i
                data-feather="link"></i></a><a class="badge rounded-circle p-2 badge-info" href="#!"><i
                data-feather="github"></i></a><a class="badge rounded-circle p-2 badge-warning text-dark" href="#!"><i
                data-feather="award"></i></a><a class="badge rounded-circle p-2 badge-danger" href="#!"><i
                data-feather="activity"></i></a><a class="badge rounded-circle p-2 badge-light text-dark" href="#!"><i
                data-feather="heart"></i></a><a class="badge rounded-circle p-2 badge-dark" href="#!"><i
                data-feather="mail"></i></a>
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#rounded-icons" title="Copy"><i
                  class="icofont icofont-copy-alt"></i></button>
              <pre
                class="custom-scrollbar"><code class="language-html" id="rounded-icons">&lt;!--You can use .rounded-circle class through change the icons badge.--&gt;
    ...
    <div class="col-sm-12 col-xl-6">
      <div class="card height-equal title-line">
        ...
        <div class="card-body">
          ...
          <h6 class="badge-heading">Badge Heading 6<span class="badge badge-dark">Logout</span></h6>
          <div class="code-box-copy">
            <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#badge-headings" title="Copy"><i
                class="icofont icofont-copy-alt"></i></button>
            <pre
              class="custom-scrollbar"><code class="language-html" id="badge-headings">&lt;!--You can use headings with .badge class.--&gt;
&lt;h1 class="badge-heading"&gt;Badge Heading 1&lt;span class="badge badge-primary"&gt;Latest&lt;/span&gt;&lt;/h1&gt;
&lt;h2 class="badge-heading"&gt;Badge Heading 2&lt;span class="badge badge-secondary"&gt;Trending&lt;/span&gt;&lt;/h2&gt;
&lt;h3 class="badge-heading"&gt;Badge Heading 3&lt;span class="badge badge-success"&gt;Checkout&lt;/span&gt;&lt;/h3&gt;
&lt;h4 class="badge-heading"&gt;Badge Heading 4&lt;span class="badge badge-warning"&gt;Inbox&lt;/span&gt;&lt;/h4&gt;
...
&lt;h6 class="badge-heading pb-0"&gt;Badge Heading 6&lt;span class="badge badge-dark"&gt;Logout&lt;/span&gt;&lt;/h6&gt;</code></pre>
    ...
    <div class="col-sm-12 col-xl-6">
      <div class="card height-equal title-line">
        <div class="card-header">
          <h2>Badges as part buttons</h2>
          <p class="f-m-light mt-2"> <code>.badge</code> can be used as part of <code>.btn</code> to provide a icons.
          </p>
          <div class="card-header-right">
            <ul class="list-unstyled card-option">
              <li><i class="fa fa-spin fa-cog"></i></li>
        ...
        <div class="card-body">
          <div class="badge-spacing flex-column align-items-start">
            ...
            <button class="btn btn-success d-flex align-items-center" type="button">Update Available <span
                class="badge rounded-circle btn-p-space badge-light text-dark ms-2"><i
            ...
            <button class="btn btn-warning text-dark d-flex align-items-center" type="button">1.2 GB Used <span
                class="badge rounded-circle btn-p-space badge-light text-dark ms-2"><i
                  data-feather="alert-triangle"></i></span></button>
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#badge-as-part-btn"
                title="Copy"><i class="icofont icofont-copy-alt"></i></button>
              <pre
                class="custom-scrollbar"><code class="language-html" id="badge-as-part-btn">&lt;!--You can use badge-* class with any icons used.(badge-icons/headings).--&gt;
&lt;div class="badge-spacing flex-column align-items-start"&gt;
