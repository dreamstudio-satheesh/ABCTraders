  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Modal</li>
      </ol>
    </nav>
  </div>
</div>
  ...
  <div class="row">
    <div class="col-lg-6">
      <div class="card title-line">
        <div class="card-header">
          <h2>Basic modal</h2>
          <p class="mt-2 f-m-light">Different types of basic modals using like
        ...
        <div class="card-body badge-spacing">
              ...
              <div class="modal-content">
                <div class="modal-body">
                  <div class="modal-toggle-wrapper">
                    <h2>Up to <strong class="txt-danger">85% OFF</strong>, Hurry Up Online Shopping</h2>
                ...
                <div class="modal-body">
                  ...
                  <div class="d-flex mt-3">
                    ...
                    <div class="flex-grow-1 ms-2">
                      <p>For a site to be successful, a designer must be able to communicate their ideas, chat with a
                  ...
                  <div class="d-flex mt-2">
                    <div class="flex-shrink-0"><i class="svg-modal" data-feather="arrow-right-circle"></i></div>
                    <div class="flex-grow-1 ms-2">
                      <p>As a web designer, you either prefer to work freelance for several different businesses at once
                        or you may choose to work for just one. In either case, you'll need good time management skills
                        to keep several projects moving forward.</p>
                    </div>
                  </div>
                  <div class="d-flex mt-2">
                    <div class="flex-shrink-0"><i class="svg-modal" data-feather="arrow-right-circle"></i></div>
                    <div class="flex-grow-1 ms-2">
                      <p>Although a designer doesn't write the code that makes a site work, it doesn't hurt to have a
                        basic understanding of HTML or CSS to make minor adjustments to a site. You'll find it simpler
                        to edit templates, improve typefaces, or change item placements if you have a basic
                        understanding of how things work.</p>
                    </div>
                  </div>
                  <div class="d-flex my-2">
                    <div class="flex-shrink-0"><i class="svg-modal" data-feather="arrow-right-circle"></i></div>
                    <div class="flex-grow-1 ms-2">
                      <p class="pb-4">Most businesses employ a certain font or typography so that clients can quickly
                        distinguish them from their rivals. Since designers now have access to a wider variety of fonts,
                        firms may more easily and precisely communicate their brands through typography.</p>
                    </div>
                  </div>
                  <h6>UX designer </h6>
                  <div class="d-flex mt-3">
                    <div class="flex-shrink-0"><i class="svg-modal" data-feather="arrow-right-circle"></i></div>
                    <div class="flex-grow-1 ms-2">
                      <p>User research, persona creation, building wireframes and interactive prototypes, and testing
                        ideas are among the common tasks of a UX designer. These duties can differ greatly between
                        organizations.</p>
                    </div>
                  </div>
                  <div class="d-flex mt-3">
                    <div class="flex-shrink-0"><i class="svg-modal" data-feather="arrow-right-circle"></i></div>
                    <div class="flex-grow-1 ms-2">
                      <p>Create solutions that will be helpful for the issues and situations that exist right now, not
                        for those that will. With the right materials, assist people in organizing their time,
                  ...
                  <div class="d-flex mt-3">
                    <div class="flex-shrink-0"><i class="svg-modal" data-feather="arrow-right-circle"></i></div>
                    <div class="flex-grow-1 ms-2">
                      <p>Based on the data received from users, improve them. Adapt existing solutions to the
                  ...
                  <div class="d-flex mt-3">
                    <div class="flex-shrink-0"><i class="svg-modal" data-feather="arrow-right-circle"></i></div>
                    <div class="flex-grow-1 ms-2">
                      <p>Keep in mind that you are creating solutions to particular challenges for a particular
                        population living in a particular habitat. Always remember to correctly contextualise your
                        thoughts and determine whether they are actually appropriate for the situation. It's sometimes
                        necessary to concede that a digital solution is not the most appropriate choice in a certain
                        circumstance.</p>
                    </div>
                  </div>
                </div>
          ...
          <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#tooltipmodal">Tooltips
            and popovers</button>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <p class="mt-2">This <a class="btn btn-success popover-test" href="#" role="button"
                      title="this is amazing content" data-bs-toggle="popover">button</a> triggers a popover on click.
                  </p>
                  <hr>
                  <h5>Tooltips in a modal</h5>
                  <p class="mt-2"><a class="tooltip-test text-info" href="#" title="Tooltip"
                      data-bs-toggle="tooltip">This link</a> and <a class="tooltip-test text-info" href="#"
                      title="Tooltip" data-bs-toggle="tooltip">that link</a> have tooltips on hover.</p>
                </div>
                <div class="modal-footer">
                  <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Close</button>
                  <button class="btn btn-primary" type="button">Save changes</button>
          ...
          <button class="btn btn-secondary" type="button" data-bs-toggle="modal"
            data-bs-target="#exampleModalgetbootstrap" data-whatever="@getbootstrap">Open modal for yuri</button>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-toggle-wrapper social-profile text-start dark-sign-up">
                  <h3 class="modal-header justify-content-center border-0">YURI SIGN-UP</h3>
                  <div class="modal-body">
                    <form class="row g-3 needs-validation" novalidate="">
                      ...
                      <div class="col-md-6">
                        ...
                        <input class="form-control" id="validationCustom02" type="text" placeholder="Enter your surname"
                          required="">
                        <div class="valid-feedback">Looks good!</div>
                      </div>
                      <div class="col-md-12">
                        <div class="mb-3">
                          ...
                          <input class="form-control" id="exampleFormControlInput1" type="email"
                            placeholder="yuritheme@gmail.com">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-check mb-3">
                          <input class="form-check-input checkbox-primary" id="flexCheckDefault" type="checkbox"
                            value="">
                          <label class="form-check-label d-block mb-0" for="flexCheckDefault">You accept our Terms and
                            Privacy Policy by clicking Submit below.</label>
                        </div>
    ...
    <div class="col-lg-6">
      <div class="card title-line">
        <div class="card-header">
          <h2>Sizes modal</h2>
          <p class="mt-2 f-m-light">Modals have three optional sizes, available via modifier classes to be placed on a
          </p><code>.modal-dialog</code>
        </div>
        <div class="card-body badge-spacing">
          <!--full screen modal-->
          <div class="btn btn-info" data-bs-toggle="modal" data-bs-target=".bd-example-modal-fullscreen">Full screen
            modal</div>
          ...
          <!--Extra large modal-->
          <div class="btn btn-primary" data-bs-toggle="modal" data-bs-target=".bd-example-modal-xl">Extra large modal
          </div>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body dark-modal">
                  ...
                  <p class="modal-padding-space mb-0">No matter how talented you are as a content writer or creator, you
                    will always fail if you don't have a clear set of goals.</p>
                  <p class="modal-padding-space mb-0">First of all, without goals, there is no way to determine your
                    success. Additionally, you lack direction.</p>
                  <p class="modal-padding-space mb-0">Together with your team, respond to the following questions to
    ...
    <div class="col-xl-12">
      <div class="card title-line">
        <div class="card-header">
          ...
          <p class="f-m-light mt-1">Another override is the option to pop up a modal that covers the user viewport,
        ...
        <div class="card-body badge-spacing">
                  ...
                  <div class="modal-details">
                    <div class="web-content">
                      ...
                      <div class="d-flex">
                        <div class="flex-shrink-0"><i class="svg-modal" data-feather="arrow-right-circle"></i></div>
                        <div class="flex-grow-1 ms-2">
                          <p>For a site to be successful, a designer must be able to communicate their ideas, chat with
                            a firm about what they want, and inquire about the target audience.</p>
                        </div>
                      </div>
                      <div class="d-flex">
                        <div class="flex-shrink-0"><i class="svg-modal" data-feather="arrow-right-circle"></i></div>
                        <div class="flex-grow-1 ms-2">
                          <p>As a web designer, you either prefer to work freelance for several different businesses at
                            once or you may choose to work for just one. In either case, you'll need good time
                      ...
                      <div class="d-flex">
                        <div class="flex-shrink-0"><i class="svg-modal" data-feather="arrow-right-circle"></i></div>
                        <div class="flex-grow-1 ms-2">
                          <p>Although a designer doesn't write the code that makes a site work, it doesn't hurt to have
                            a basic understanding of HTML or CSS to make minor adjustments to a site. You'll find it
                            simpler to edit templates, improve typefaces, or change item placements if you have a basic
                            understanding of how things work.</p>
                        </div>
                      </div>
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-2">
                          <p>
                            Most businesses employ a certain font or typography so that clients can quickly distinguish
                            them from their rivals. Since designers now have access to a wider variety of fonts, firms
                            may more easily and precisely communicate their brands through typography.</p>
                        </div>
                      </div>
                    </div>
                    <div class="web-content">
                      ...
                      <div class="d-flex">
                        <div class="flex-shrink-0"><i class="svg-modal" data-feather="arrow-right-circle"></i></div>
                        <div class="flex-grow-1 ms-2">
                          <p>User research, persona creation, building wireframes and interactive prototypes, and
                            testing ideas are among the common tasks of a UX designer. These duties can differ greatly
                      ...
                      <div class="d-flex">
                        <div class="flex-shrink-0"><i class="svg-modal" data-feather="arrow-right-circle"></i></div>
                        <div class="flex-grow-1 ms-2">
                          <p>Create solutions that will be helpful for the issues and situations that exist right now,
                            not for those that will. With the right materials, assist people in organizing their time,
                            completing things more quickly, and optimizing it.</p>
                        </div>
                      </div>
                      <div class="d-flex">
                      ...
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-2">
                          <p>Keep in mind that you are creating solutions to particular challenges for a particular
                            population living in a particular habitat. Always remember to correctly contextualise your
                            thoughts and determine whether they are actually appropriate for the situation. It's
                            sometimes necessary to concede that a digital solution is not the most appropriate choice in
                            a certain circumstance.</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="modal fade" id="exampleModalfullscreensm" tabindex="-1" aria-labelledby="smModalLabel"
            aria-hidden="true">
                  ...
                  <div class="modal-details">
                    <div class="web-content">
                      ...
                      <div class="d-flex">
                        <div class="flex-shrink-0"><i class="svg-modal" data-feather="arrow-right-circle"></i></div>
                        <div class="flex-grow-1 ms-2">
                          <p>Most businesses employ a certain font or typography so that clients can quickly distinguish
                            them from their rivals. Since designers now have access to a wider variety of fonts, firms
                            may more easily and precisely communicate their brands through typography.</p>
                        </div>
                      </div>
          ...
          <div class="modal fade" id="exampleModalfullscreen-md" tabindex="-1" aria-labelledby="mdModalLabel"
            aria-hidden="true">
          ...
          <div class="modal fade" id="exampleModalfullscreen-lg" tabindex="-1" aria-labelledby="lgModalLabel"
            aria-hidden="true">
          ...
          <div class="modal fade" id="exampleModalfullscreen-xl" tabindex="-1" aria-labelledby="xlModalLabel"
            aria-hidden="true">
          ...
          <div class="modal fade" id="exampleModalfullscreen-xxl" tabindex="-1" aria-labelledby="xxlModalLabel"
            aria-hidden="true">
      ...
      <div class="card title-line">
        <div class="card-header">
          ...
          <p class="f-m-light mt-1">
            Use the <code>.modal-dialog-centered</code> through centered modal. and set <code>data-bs-target</code>.</p>
        </div>
        <div class="card-body">
          <!--Centered modal-->
          <button class="btn btn-success" type="button" data-bs-toggle="modal"
              ...
              <div class="modal-content">
                <div class="modal-body">
                  <div class="modal-toggle-wrapper">
                    ...
                    <p class="text-center">Attackers on malicious activity may trick you into doing something dangrous
                      like installing software or revealing your personal informations.</p>
              ...
              <div class="modal-content">
                <div class="modal-body">
                  <div class="modal-toggle-wrapper">
                    ...
                    <button class="btn btn-dark rounded-pill w-100 mt-4" data-bs-target="#exampleModalToggle2"
                      data-bs-toggle="modal">Connect new account</button>
                  ...
                  <div class="modal-toggle-wrapper">
                    ...
                    <p class="text-center">Are you sure want to logout this dashboard?</p><span
                      class="d-block text-center mb-4"> Not a member?<a class="ms-1"
                        href="{{ route('admin.sign-up') }}">Register</a></span>
                    <button class="btn btn-dark d-flex m-auto" type="button" data-bs-dismiss="modal">Yes, Log
                      out</button>
                  </div>
                </div>
              </div>
    ...
    <div class="col-xl-4">
      <div class="card title-line">
        <div class="card-header">
          ...
          <p class="f-m-light mt-1">
            When backdrop is set to static, the modal will not close when clicking outside of it. Click the button below
            to try it.</p>
        </div>
        <div class="card-body">
          <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Static
            ...
            <div class="modal-dialog">
              <div class="modal-content dark-sign-up">
                <div class="modal-body social-profile text-start">
                  <div class="modal-toggle-wrapper">
                    <h3 class="f-w-600">Yuri Login</h3>
                    <p>
              ...
              <div class="card-wrapper border rounded-3 h-100">
                <div class="yuri-demo-img">
                  ...
                  <div class="title-wrapper pb-3 modal-heading">
                    ...
                    <p>Example of yuri dashboard profile card.</p>
                  </div>
                  <div class="overflow-hidden"><img class="img-fluid"
                      src="{{ asset('assets/images/modal/social.png') }}" alt="social">
                    <button class="btn btn-primary mx-auto mt-3" type="button" data-bs-toggle="modal"
                      data-bs-target="#exampleModallaptop1">Click Out</button>
                  </div>
                          ...
                          <div class="card social-profile mb-0">
                            <div class="card-body">
                              <div class="social-img-wrap">
                                <div class="social-img"><img src="{{ asset('assets/images/avtar/1.jpg') }}"
                                    alt="profile"></div>
                                <div class="edit-icon">
                                  <svg>
                              ...
                              <div class="social-details">
                                <h3 class="mb-1 f-w-600"><a href="{{ route('admin.social-app') }}">Brooklyn Simmons</a>
                                </h3>
                                <span class="f-light">@brookly.simmons</span>
                                <ul class="social-follow">
                                  <li>
                                    <h3 class="mb-0 f-w-600">1,908</h3><span class="f-light">Posts</span>
                                  </li>
                                  <li>
                                    <h3 class="mb-0 f-w-600">34.0k</h3><span class="f-light">Followers</span>
                                  </li>
                                  <li>
                                    <h3 class="mb-0 f-w-600">897</h3><span class="f-light">Following</span>
                                  </li>
                                </ul>
                              </div>
                            </div>
              ...
              <div class="card-wrapper border rounded-3 h-100">
                <div class="yuri-demo-img">
                  ...
                  <div class="title-wrapper pb-3 modal-heading">
                    ...
                    <p>Example of yuri login form.</p>
                  </div>
                  <div class="overflow-hidden"><img class="img-fluid"
                      src="{{ asset('assets/images/modal/learning.png') }}" alt="learning">
                    <button class="btn btn-primary mx-auto mt-3" type="button" data-bs-toggle="modal"
                      data-bs-target="#exampleModallogin">Click Out</button>
                  </div>
                          ...
                          <div class="modal-toggle-wrapper">
                            ...
                            <form class="row g-3">
                              <div class="col-md-12">
                                ...
                                <input class="form-control" id="inputEmailEnter" type="email"
                                  placeholder="Enter Your Email">
                              </div>
                              <div class="col-md-12">
                                <label class="form-label" for="inputPasswordEnter">Password</label>
                                <input class="form-control" id="inputPasswordEnter" type="password"
                                  placeholder="Enter Your Password">
                              </div>
                              <div class="col-12">
                                <div class="form-check">
              ...
              <div class="card-wrapper border rounded-3 h-100">
                <div class="yuri-demo-img">
                  ...
                  <div class="title-wrapper pb-3 modal-heading">
                    ...
                    <p>Example of yuri dashboard balance card.</p>
                  </div>
                  <div class="overflow-hidden balance-modal"><img class="img-fluid"
                      src="{{ asset('assets/images/modal/balance.png') }}" alt="balance">
                    <button class="btn btn-primary mx-auto mt-3" type="button" data-bs-toggle="modal"
                      data-bs-target="#exampleModalbalancebox">Click Out</button>
                  </div>
                  <div class="modal fade" id="exampleModalbalancebox" tabindex="-1" role="dialog"
                    aria-labelledby="exampleModalbalancebox" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="col-xl-12">
                          <div class="card balance-box mb-0">
                            <div class="card-body">
                              <div class="balance-profile">
                                <div class="balance-img"><img src="{{ asset('assets/images/avtar/user.png') }}"
                                    alt="user vector"><a class="edit-icon" href="{{ route('admin.user-profile') }}">
                                    <svg>
                                      <use href="{{ asset('assets/svg/icon-sprite.svg#pencil') }}"></use>
                                    </svg></a></div><span class="f-light d-block">Your Balance </span>
                                <h3 class="mt-1 f-w-600">$768,987.90</h3>
                                <ul>
                                  <li>
                                    <div class="balance-item danger">
                                      ...
                                      <div> <span class="f-12 f-light">Investment </span>
                                        <h3 class="f-w-600">78.8K</h3><span
                                  ...
                                  <li>
                                    <div class="balance-item success">
                                      ...
                                      <div> <span class="f-12 f-light">Cash Back</span>
                                        <h3 class="f-w-600">19.7K</h3><span
