    ...
    <div>
        ...
        <nav>
            <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
                ...
                <li class="breadcrumb-item f-w-500">Learning</li>
                <li class="breadcrumb-item f-w-500 active">Detailed Course</li>
            </ol>
        </nav>
    </div>
</div>
                ...
                <div class="card-body">
                    <div class="blog-single">
                        <div class="blog-box blog-details"><img class="img-fluid w-100"
                            ...
                            <div class="blog-details pb-0">
                                ...
                                <h4>Knowledge can be defined as awareness of facts or as practical skills. there is wide
                                    agreement among philosophers that it is a form of true belief. Internet.</h4>
                        ...
                        <section class="comment-box">
                            ...
                            <ul>
                                <li>
                                    <div class="d-flex align-self-start"><img class="align-self-start"
                                ...
                                <li>
                                    <ul>
                                        <li>
                                            <div class="d-flex"><img class="align-self-start"
                ...
                <div class="md-sidebar-aside job-sidebar custom-scrollbar">
                    <div class="default-according style-1 faq-accordion job-accordion" id="accordionoc">
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="card learning-dropbox">
                                    <div class="card-header">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link" data-bs-toggle="collapse"
                                    ...
                                    <div class="collapse card-body px-0 show" id="collapseicon1"
                                        ...
                                        <div class="categories pt-0">
                                            <div class="learning-header">
                                                <h5 class="f-w-600">Development</h5>
                                            </div>
                                            <ul>
                                ...
                                <div class="card">
                                    ...
                                    <div class="collapse show" id="collapseicon2" aria-labelledby="collapseicon2"
                                        ...
                                        <div class="upcoming-course card-body">
                                            <div class="d-flex">
                                                <div class="flex-grow-1">
                                                    <h5 class="f-w-600">UX Development</h5><span class="d-block">Course
                                                        By <a href="#!">Howard
                                                            Moore</a></span><span class="d-block"><i
                                                            class="fa fa-star font-warning"></i><i
                                                            class="fa fa-star font-warning"></i><i
                                                            class="fa fa-star font-warning"></i><i
                                                            class="fa fa-star font-warning"></i><i
                                                            class="fa fa-star-half-o font-warning"></i></span>
                                                </div>
                                                <div>
                                                    <h5 class="mb-0 font-primary">02</h5><span
                                                        class="d-block">Feb</span>
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <div class="flex-grow-1">
                                                    <h6 class="f-w-600">Business Analyst</h6><span
                                                        class="d-block">Course By <a href="#!">Crystal
                                                            Markey</a></span><span class="d-block"><i
                                                            class="fa fa-star font-warning"></i><i
                                                            class="fa fa-star font-warning"></i><i
                                                            class="fa fa-star font-warning"></i><i
                                                            class="fa fa-star font-warning"></i><i
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-grow-1">
                                                    <h6 class="f-w-600">Web Development</h6><span class="d-block">Course
                                                        By <a href="#!">Jerry
                                                            Reel</a></span><span class="d-block"><i
                                                            class="fa fa-star font-warning"></i><i
                                                            class="fa fa-star font-warning"></i><i
                                                            class="fa fa-star font-warning"></i><i
                                                            class="fa fa-star font-warning"></i><i
                                                            class="fa fa-star-o font-warning"></i></span>
                                                </div>
                                                <div>
                                                    <h5 class="mb-0 font-primary">12</h5><span
                                                        class="d-block">July</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
