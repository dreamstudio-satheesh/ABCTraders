  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Animate</li>
      </ol>
    </nav>
  </div>
</div>
          ...
          <div class="row">
            <div class="col-xl-6 col-md-8 offset-xl-3 offset-md-2">
                ...
                <div class="card">
                  <div class="animate-widget">
                    ...
                    <div class="text-center p-25">
                      <p class="text-muted mb-0">Denouncing pleasure and praising pain was born and I will give you a
              ...
              <form class="theme-form text-center">
                <div class="mb-3">
                  <select class="form-select input input--dropdown js-animations">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2>How to use it?</h2>
          <p class="f-m-light mt-1">All you have to do is to add animation name class attribute to html element, like :
            <code>Fade</code>
          </p>
        </div>
