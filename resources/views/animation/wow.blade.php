    ...
    <div>
        ...
        <nav>
            <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
                ...
                <li class="breadcrumb-item f-w-500 active">Wow Animation</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="col-sm-12">
                ...
                <div class="card-body">
                    <div class="row gallery grid my-gallery" id="aniimated-thumbnials" itemscope="">
                        <figure class="grid-item col-md-3 col-6 wow rollIn" itemprop="associatedMedia"
                            data-wow-delay="0.5s" itemscope=""><a href="{{ asset('assets/images/big-masonry/1.jpg') }}"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow bounceInDown center" itemprop="associatedMedia"
                            data-wow-delay="0.5s" itemscope=""><a href="{{ asset('assets/images/big-masonry/2.jpg') }}"
                                itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow lightSpeedIn" itemprop="associatedMedia"
                            data-wow-delay="0.5s" itemscope=""><a href="{{ asset('assets/images/big-masonry/3.jpg') }}"
                                itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow rollIn center" itemprop="associatedMedia"
                            itemscope=""><a href="{{ asset('assets/images/big-masonry/4.jpg') }}" itemprop="contentUrl"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow pulse" itemprop="associatedMedia"
                            data-wow-iteration="5" data-wow-duration="0.15s" itemscope=""><a
                                href="{{ asset('assets/images/big-masonry/5.jpg') }}" itemprop="contentUrl"
                                data-size="1600x950"><img class="img-thumbnail"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow bounceInRight center" itemprop="associatedMedia"
                            itemscope=""><a href="{{ asset('assets/images/big-masonry/6.jpg') }}" itemprop="contentUrl"
                                data-size="1600x950"><img class="img-thumbnail"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow bounceInLeft" itemprop="associatedMedia"
                            itemscope=""><a href="{{ asset('assets/images/big-masonry/7.jpg') }}" itemprop="contentUrl"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow flipInX center" itemprop="associatedMedia"
                            itemscope=""><a href="{{ asset('assets/images/big-masonry/8.jpg') }}" itemprop="contentUrl"
                                data-size="1600x950"><img class="img-thumbnail"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow bounceInRight" itemprop="associatedMedia"
                            itemscope=""><a href="{{ asset('assets/images/big-masonry/9.jpg') }}" itemprop="contentUrl"
                                data-size="1600x950"><img class="img-thumbnail"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow rollIn center" itemprop="associatedMedia"
                            itemscope=""><a href="{{ asset('assets/images/big-masonry/10.jpg') }}" itemprop="contentUrl"
                                data-size="1600x950"><img class="img-thumbnail"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow shake" itemprop="associatedMedia"
                            data-wow-iteration="5" data-wow-duration="0.15s" itemscope=""><a
                                href="{{ asset('assets/images/big-masonry/11.jpg') }}" itemprop="contentUrl"
                                data-size="1600x950"><img class="img-thumbnail"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow swing center" itemprop="associatedMedia"
                            data-wow-iteration="2" itemscope=""><a
                                href="{{ asset('assets/images/big-masonry/12.jpg') }}" itemprop="contentUrl"
                                data-size="1600x950"><img class="img-thumbnail"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow rollIn" itemprop="associatedMedia" itemscope=""><a
                                href="{{ asset('assets/images/big-masonry/14.jpg') }}" itemprop="contentUrl"
                                data-size="1600x950"><img class="img-thumbnail"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow bounceInUp center" itemprop="associatedMedia"
                            data-wow-delay="0.5s" itemscope=""><a href="{{ asset('assets/images/big-masonry/15.jpg') }}"
                                itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow lightSpeedIn" itemprop="associatedMedia"
                            data-wow-delay="0.5s" data-wow-duration="0.15s" itemscope=""><a
                                href="{{ asset('assets/images/big-masonry/13.jpg') }}" itemprop="contentUrl"
                                data-size="1600x950"><img class="img-thumbnail"
                        ...
                        <figure class="grid-item col-md-3 col-6 wow pulse" itemprop="associatedMedia"
                            data-wow-iteration="5" data-wow-duration="0.25s" itemscope=""><a
                                href="{{ asset('assets/images/big-masonry/5.jpg') }}" itemprop="contentUrl"
                                data-size="1600x950"><img class="img-thumbnail"
                                    src="{{ asset('assets/images/masonry/5.jpg') }}" itemprop="thumbnail"
                                    alt="Image description"></a>
                        ...
                        <figure class="grid-item col-md-3 col-6 wow flip" itemprop="associatedMedia"
                            data-wow-iteration="2" data-wow-duration="0.15s" itemscope=""><a
                                href="{{ asset('assets/images/big-masonry/9.jpg') }}" itemprop="contentUrl"
                                data-size="1600x950"><img class="img-thumbnail"
                                    src="{{ asset('assets/images/masonry/9.jpg') }}" itemprop="thumbnail"
                                    alt="Image description"></a>
                        ...
                        <figure class="grid-item col-md-3 col-6 wow bounce" itemprop="associatedMedia"
                            data-wow-iteration="5" data-wow-duration="0.15s" itemscope=""><a
                                href="{{ asset('assets/images/big-masonry/7.jpg') }}" itemprop="contentUrl"
                                data-size="11600x950"><img class="img-thumbnail"
                                    src="{{ asset('assets/images/masonry/7.jpg') }}" itemprop="thumbnail"
                                    alt="Image description"></a>
                        ...
                        <figure class="grid-item col-md-3 col-6 wow rollIn" itemprop="associatedMedia"
                            data-wow-delay="0.5s" itemscope=""><a href="{{ asset('assets/images/big-masonry/11.jpg') }}"
                                itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                                    src="{{ asset('assets/images/masonry/11.jpg') }}" itemprop="thumbnail"
                                    alt="Image description"></a>
                        ...
                        <figure class="grid-item col-md-3 col-6 wow bounceInDown center" itemprop="associatedMedia"
                            data-wow-delay="1s" itemscope=""><a href="{{ asset('assets/images/big-masonry/12.jpg') }}"
                                itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                                    src="{{ asset('assets/images/masonry/12.jpg') }}" itemprop="thumbnail"
                                    alt="Image description"></a>
                        ...
                        <figure class="grid-item col-md-3 col-6 wow bounceInRight" itemprop="associatedMedia"
                            data-wow-delay="1.5s" itemscope=""><a href="{{ asset('assets/images/big-masonry/14.jpg') }}"
                                itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                                    src="{{ asset('assets/images/masonry/14.jpg') }}" itemprop="thumbnail"
                                    alt="Image description"></a>
                        ...
                        <figure class="grid-item col-md-3 col-6 wow bounceInRight center" itemprop="associatedMedia"
                            itemscope=""><a href="{{ asset('assets/images/big-masonry/15.jpg') }}" itemprop="contentUrl"
                                data-size="1600x950"><img class="img-thumbnail"
                                    src="{{ asset('assets/images/masonry/15.jpg') }}" itemprop="thumbnail"
                                    alt="Image description"></a>
                        ...
                        <figure class="grid-item col-md-3 col-6 wow rollIn" itemprop="associatedMedia"
                            data-wow-delay="0.5s" itemscope=""><a href="{{ asset('assets/images/big-masonry/13.jpg') }}"
                                itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                                    src="{{ asset('assets/images/masonry/13.jpg') }}" itemprop="thumbnail"
                                    alt="Image description"></a>
                        ...
                        <figure class="grid-item col-md-3 col-6 wow lightSpeedIn" itemprop="associatedMedia"
                            itemscope=""><a href="{{ asset('assets/images/big-masonry/5.jpg') }}" itemprop="contentUrl"
                                data-size="1600x950"><img class="img-thumbnail"
                                    src="{{ asset('assets/images/masonry/5.jpg') }}" itemprop="thumbnail"
                                    alt="Image description"></a>
            ...
            <div class="card">
                <div class="card-header wow-title">
                    <h2><span class="badge badge-primary rounded-pill me-2">1</span>Setup wow.js</h2>
                    <p class="f-m-light mt-1">(You can link to another CSS animation library by changing wow.js
                        settings)</p>
                </div>
                <div class="card-body">
                    <div>
                        <div class="line"><code><span>&lt;link rel="stylesheet" href="css/animate.css"
                                        &gt;</span></code></div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header wow-title">
                    <h2><span class="badge badge-primary rounded-pill me-2">2</span>Link and activate wow.js</h2>
                </div>
                <div class="card-body">
                    <div>
                        <div class="line">&lt; script
                            src="js/wow.min.js" &gt; &lt; /script &gt; <br />&lt; script &gt; <br /><code>
                                    WOW.init();</code><br />&lt; /script &gt;</div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header wow-title">
                    <h2><span class="badge badge-primary rounded-pill me-2">3</span>Make an element revealable</h2>
                    <p class="f-m-light mt-1">(You can change this CSS class in the WOW settings to avoid name
                        conflicts.)</p>
                </div>
                <div class="card-body">
                    <h6 class="text-muted">Add the CSS class .wow to a HTML element: it will be invisible until the
                        user scrolls to reveal it.</h6>
                    <div>
                        <div class="line">&lt; div class="wow" &gt; <br /><code>Content to Reveal
                                    Here</code><br />&lt; /div &gt;</div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header wow-title">
                    <h2><span class="badge badge-primary rounded-pill me-2">4</span>Choose the animation style</h2>
                    <p class="f-m-light mt-1">Pick an animation style in Animate.css , then add the CSS class to the
                        HTML element</p>
                </div>
                <div class="card-body">
                    <div>
                        <div class="line">&lt; div class="wow bounceInUp" &gt; <br /><code>Content to Reveal
                                    Here</code><br />&lt; /div &gt;</div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header wow-title">
                    <h2><span class="badge badge-success rounded-pill me-2">Extra</span>Advance Options</h2>
                </div>
                <div class="card-body">
                    <div>
                        <div class="line">
            ...
            <div class="card">
                <div class="card-header wow-title">
                    <h2><span class="badge badge-danger rounded-pill me-2">Settings</span>Customize Settings</h2>
                </div>
                <div class="card-body">
                    <div>
                        <div class="line">
