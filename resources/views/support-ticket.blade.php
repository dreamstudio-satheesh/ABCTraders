    ...
    <div>
        ...
        <nav>
            <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
                ...
                <li class="breadcrumb-item f-w-500">Support Ticket</li>
                <li class="breadcrumb-item f-w-500 active">Support Ticket</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="f-m-light mt-1">List of ticket opend by customers</p>
                </div>
                <div class="card-body">
                    <div class="row">
