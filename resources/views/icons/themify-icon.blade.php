  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Themify Icons</li>
      </ol>
    </nav>
  </div>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2 class="m-b-0">Arrows & Direction Icons</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icon-angle-double-right"></i> icon-angle-double-right
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icon-arrow-circle-right"></i> icon-arrow-circle-right
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icon-shopping-cart-full"></i> icon-shopping-cart-full
            </div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Control Icons</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icon-control-skip-forward"></i> icon-control-skip-forward
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icon-control-skip-backward"></i>
              icon-control-skip-backward</div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icon-themify-favicon-alt"></i> icon-themify-favicon-alt
            </div>
          </div>
        </div>
      </div>
