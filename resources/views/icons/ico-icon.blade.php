  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500">Icons</li>
        <li class="breadcrumb-item f-w-500 active">ICO Icons</li>
      </ol>
    </nav>
  </div>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2 class="m-b-0">Abstract</h2>
          <p class="f-m-light mt-1">New</p>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-halloween-pumpkin"></i>halloween-pumpkin
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-bear-tracks"></i>animal-bear-tracks
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-camel-alt"></i>animal-camel-alt
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-camel-head"></i>animal-camel-head
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-cat"></i>animal-cat</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-cat-alt-1"></i>animal-cat-alt-1
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-cat-alt-2"></i>animal-cat-alt-2
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-cat-alt-3"></i>animal-cat-alt-3
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-cat-alt-4"></i>animal-cat-alt-4
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-cat-with-dog"></i>animal-cat-with-dog</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-crocodile"></i>animal-crocodile
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-deer-head"></i>animal-deer-head
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-dog-barking"></i>animal-dog-barking
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-dolphin"></i>animal-dolphin</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-duck-tracks"></i>animal-duck-tracks
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-eagle-head"></i>animal-eagle-head
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-eaten-fish"></i>animal-eaten-fish
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-elephant"></i>animal-elephant</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-elephant-alt"></i>animal-elephant-alt</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-elephant-head"></i>animal-elephant-head</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-elephant-head-alt"></i>animal-elephant-head-alt</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-fish-alt-1"></i>animal-fish-alt-1
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-fish-alt-2"></i>animal-fish-alt-2
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-fish-alt-3"></i>animal-fish-alt-3
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-fish-alt-4"></i>animal-fish-alt-4
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-frog-tracks"></i>animal-frog-tracks
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-giraffe-alt"></i>animal-giraffe-alt
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-goat-head"></i>animal-goat-head
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-goat-head-alt-1"></i>animal-goat-head-alt-1</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-goat-head-alt-2"></i>animal-goat-head-alt-2</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-gorilla"></i>animal-gorilla</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-hen-tracks"></i>animal-hen-tracks
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-horse-head"></i>animal-horse-head
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-horse-head-alt-1"></i>animal-horse-head-alt-1</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-horse-head-alt-2"></i>animal-horse-head-alt-2</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-horse-tracks"></i>animal-horse-tracks</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-jellyfish"></i>animal-jellyfish
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-lion-head"></i>animal-lion-head
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-lion-head-alt"></i>animal-lion-head-alt</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-monkey"></i>animal-monkey</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-monkey-alt-1"></i>animal-monkey-alt-1</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-monkey-alt-2"></i>animal-monkey-alt-2</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-monkey-alt-3"></i>animal-monkey-alt-3</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-octopus"></i>animal-octopus</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-octopus-alt"></i>animal-octopus-alt
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-panda-alt"></i>animal-panda-alt
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-parrot-lip"></i>animal-parrot-lip
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-pigeon-alt"></i>animal-pigeon-alt
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-pigeons"></i>animal-pigeons</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-animal-rabbit-running"></i>animal-rabbit-running</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-rhino-head"></i>animal-rhino-head
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-snail-alt-1"></i>animal-snail-alt-1
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-snail-alt-2"></i>animal-snail-alt-2
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-tiger-alt"></i>animal-tiger-alt
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-animal-woodpecker"></i>animal-woodpecker
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-brand-air-new-zealand"></i>brand-air-new-zealand</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-aliexpress"></i>brand-aliexpress
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-brand-american-airlines"></i>brand-american-airlines</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-android"></i>brand-android</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-brand-android-robot"></i>brand-android-robot</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-blackberry"></i>brand-blackberry
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-burger-king"></i>brand-burger-king
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-brand-business-insider"></i>brand-business-insider</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-china-mobile"></i>brand-china-mobile
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-brand-china-telecom"></i>brand-china-telecom</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-china-unicom"></i>brand-china-unicom
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-cocal-cola"></i>brand-cocal-cola
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-designbump"></i>brand-designbump
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-designfloat"></i>brand-designfloat
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-brand-etihad-airways"></i>brand-etihad-airways</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-foursquare"></i>brand-foursquare
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-brand-general-electric"></i>brand-general-electric</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-joomshaper"></i>brand-joomshaper
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-kickstarter"></i>brand-kickstarter
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-life-hacker"></i>brand-life-hacker
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-brand-line-messenger"></i>brand-line-messenger</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-linux-mint"></i>brand-linux-mint
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-lionix"></i>brand-lionix</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-brand-live-messenger"></i>brand-live-messenger</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-loreal"></i>brand-loreal</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-brand-louis-vuitton"></i>brand-louis-vuitton</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-mac-os"></i>brand-mac-os</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-marvel-app"></i>brand-marvel-app
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-playstation"></i>brand-playstation
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-readernaut"></i>brand-readernaut
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-brand-saudia-airlines"></i>brand-saudia-airlines</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-sk-telecom"></i>brand-sk-telecom
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-slideshare"></i>brand-slideshare
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-brand-smashing-magazine"></i>brand-smashing-magazine</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-brand-sony-ericsson"></i>brand-sony-ericsson</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-soundcloud"></i>brand-soundcloud
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-tata-indicom"></i>brand-tata-indicom
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-techcrunch"></i>brand-techcrunch
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-telenor"></i>brand-telenor</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-teliasonera"></i>brand-teliasonera
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-thenextweb"></i>brand-thenextweb
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-volkswagen"></i>brand-volkswagen
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-walmart"></i>brand-walmart</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-brand-warnerbros"></i>brand-warnerbros
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-presentation-alt"></i>presentation-alt
            </div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Chart</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-chart-arrows-axis"></i>chart-arrows-axis
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-chart-flow-alt-1"></i>chart-flow-alt-1
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-chart-flow-alt-2"></i>chart-flow-alt-2
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-chart-histogram"></i>chart-histogram</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-chart-histogram-alt"></i>chart-histogram-alt</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-chart-radar-graph"></i>chart-radar-graph
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Construction</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-architecture"></i>architecture</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-architecture-alt"></i>architecture-alt
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-fire-extinguisher-alt"></i>fire-extinguisher-alt</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-industries-alt-1"></i>industries-alt-1
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-industries-alt-2"></i>industries-alt-2
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-industries-alt-3"></i>industries-alt-3
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-industries-alt-4"></i>industries-alt-4
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-industries-alt-5"></i>industries-alt-5
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-safety-hat-light"></i>safety-hat-light
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-under-construction"></i>under-construction
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-under-construction-alt"></i>under-construction-alt</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-vehicle-delivery-van"></i>vehicle-delivery-van</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-vehicle-dozer"></i>vehicle-dozer</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-vehicle-excavator"></i>vehicle-excavator
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-vehicle-trucktor"></i>vehicle-trucktor
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-vehicle-wrecking"></i>vehicle-wrecking
            </div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Currency</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-afghani"></i>cur-afghani</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-afghani-false"></i>cur-afghani-false
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-afghani-minus"></i>cur-afghani-minus
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-afghani-plus"></i>cur-afghani-plus
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-afghani-true"></i>cur-afghani-true
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-bitcoin-false"></i>cur-bitcoin-false
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-bitcoin-minus"></i>cur-bitcoin-minus
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-bitcoin-plus"></i>cur-bitcoin-plus
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-bitcoin-true"></i>cur-bitcoin-true
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-dollar"></i>cur-dollar</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-dollar-flase"></i>cur-dollar-flase
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-dollar-minus"></i>cur-dollar-minus
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-hryvnia-false"></i>cur-hryvnia-false
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-hryvnia-minus"></i>cur-hryvnia-minus
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-hryvnia-plus"></i>cur-hryvnia-plus
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-hryvnia-true"></i>cur-hryvnia-true
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-peseta-false"></i>cur-peseta-false
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-peseta-minus"></i>cur-peseta-minus
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-renminbi-false"></i>cur-renminbi-false
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-renminbi-minus"></i>cur-renminbi-minus
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-renminbi-plus"></i>cur-renminbi-plus
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-renminbi-true"></i>cur-renminbi-true
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-rouble-false"></i>cur-rouble-false
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-rouble-minus"></i>cur-rouble-minus
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cur-turkish-lira"></i>cur-turkish-lira
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-cur-turkish-lira-false"></i>cur-turkish-lira-false</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-cur-turkish-lira-minus"></i>cur-turkish-lira-minus</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-cur-turkish-lira-plus"></i>cur-turkish-lira-plus</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-cur-turkish-lira-true"></i>cur-turkish-lira-true</div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-keyboard-wireless"></i>keyboard-wireless
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-curved-double-left"></i>curved-double-left
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-curved-double-right"></i>curved-double-right</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-hand-drawn-alt-down"></i>hand-drawn-alt-down</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-hand-drawn-alt-left"></i>hand-drawn-alt-left</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-hand-drawn-alt-right"></i>hand-drawn-alt-right</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-hand-drawn-alt-up"></i>hand-drawn-alt-up
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-hand-drawn-right"></i>hand-drawn-right
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-line-block-right"></i>line-block-right
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-long-arrow-right"></i>long-arrow-right
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-long-arrow-up"></i>long-arrow-up</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-rounded-collapse"></i>rounded-collapse
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-rounded-double-left"></i>rounded-double-left</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-rounded-double-right"></i>rounded-double-right</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-rounded-left-down"></i>rounded-left-down
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-rounded-right-down"></i>rounded-right-down
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-rounded-right-up"></i>rounded-right-up
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-rounded-up"></i>rounded-up</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-scroll-bubble-down"></i>scroll-bubble-down
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-scroll-bubble-left"></i>scroll-bubble-left
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-scroll-bubble-right"></i>scroll-bubble-right</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-scroll-bubble-up"></i>scroll-bubble-up
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-scroll-double-down"></i>scroll-double-down
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-scroll-double-left"></i>scroll-double-left
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-scroll-double-right"></i>scroll-double-right</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-scroll-double-up"></i>scroll-double-up
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-scroll-long-down"></i>scroll-long-down
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-scroll-long-left"></i>scroll-long-left
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-scroll-long-right"></i>scroll-long-right
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-simple-left-down"></i>simple-left-down
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-simple-right-down"></i>simple-right-down
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-thin-double-left"></i>thin-double-left
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-thin-double-right"></i>thin-double-right
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-certificate-alt-1"></i>certificate-alt-1
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-certificate-alt-2"></i>certificate-alt-2
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-emo-expressionless"></i>emo-expressionless
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-emo-rolling-eyes"></i>emo-rolling-eyes
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-emo-sad"></i>emo-sad</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-emo-simple-smile"></i>emo-simple-smile
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-emo-slightly-smile"></i>emo-slightly-smile
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-emo-smirk"></i>emo-smirk</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-emo-stuck-out-tongue"></i>emo-stuck-out-tongue</div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-file-presentation"></i>file-presentation
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-file-spreadsheet"></i>file-spreadsheet
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-bell-pepper-capsicum"></i>bell-pepper-capsicum</div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-baby-milk-bottle"></i>baby-milk-bottle
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-police-car-alt-1"></i>police-car-alt-1
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-police-car-alt-2"></i>police-car-alt-2
            </div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Mathematical</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-calculator-alt-1"></i>calculator-alt-1
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-calculator-alt-2"></i>calculator-alt-2
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-circle-ruler"></i>circle-ruler</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-circle-ruler-alt"></i>circle-ruler-alt
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-mathematical-alt-1"></i>mathematical-alt-1
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-mathematical-alt-2"></i>mathematical-alt-2
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-pen-holder-alt-1"></i>pen-holder-alt-1
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-ruler-compass-alt"></i>ruler-compass-alt
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-ruler-pencil"></i>ruler-pencil</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-ruler-pencil-alt-1"></i>ruler-pencil-alt-1
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-ruler-pencil-alt-2"></i>ruler-pencil-alt-2
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-injection-syringe"></i>injection-syringe
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-medical-sign-alt"></i>medical-sign-alt
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-operation-theater"></i>operation-theater
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-paralysis-disability"></i>paralysis-disability</div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-ui-video-message"></i>ui-video-message
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-retro-music-disk"></i>retro-music-disk
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-american-express"></i>american-express
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-american-express-alt"></i>american-express-alt</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-bank-transfer-alt"></i>bank-transfer-alt
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-cash-on-delivery"></i>cash-on-delivery
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-cash-on-delivery-alt"></i>cash-on-delivery-alt</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-diners-club-alt-1"></i>diners-club-alt-1
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-diners-club-alt-2"></i>diners-club-alt-2
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-diners-club-alt-3"></i>diners-club-alt-3
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-google-wallet-alt-1"></i>google-wallet-alt-1</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-google-wallet-alt-2"></i>google-wallet-alt-2</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-google-wallet-alt-3"></i>google-wallet-alt-3</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-western-union-alt"></i>western-union-alt
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-business-man-alt-1"></i>business-man-alt-1
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-business-man-alt-2"></i>business-man-alt-2
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-business-man-alt-3"></i>business-man-alt-3
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-woman-in-glasses"></i>woman-in-glasses
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-restaurant-search"></i>restaurant-search
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-baidu-tieba"></i>social-baidu-tieba
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-social-bbm-messenger"></i>social-bbm-messenger</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-bootstrap"></i>social-bootstrap
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-brightkite"></i>social-brightkite
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-cloudapp"></i>social-cloudapp</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-concrete5"></i>social-concrete5
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-delicious"></i>social-delicious
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-designbump"></i>social-designbump
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-designfloat"></i>social-designfloat
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-deviantart"></i>social-deviantart
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-social-facebook-messenger"></i>social-facebook-messenger</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-feedburner"></i>social-feedburner
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-foursquare"></i>social-foursquare
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-friendfeed"></i>social-friendfeed
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-google-buzz"></i>social-google-buzz
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-social-google-hangouts"></i>social-google-hangouts</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-google-map"></i>social-google-map
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-google-plus"></i>social-google-plus
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-google-talk"></i>social-google-talk
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-social-hype-machine"></i>social-hype-machine</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-instagram"></i>social-instagram
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-kakaotalk"></i>social-kakaotalk
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-kickstarter"></i>social-kickstarter
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-linux-mint"></i>social-linux-mint
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-livejournal"></i>social-livejournal
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-social-odnoklassniki"></i>social-odnoklassniki</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-opencart"></i>social-opencart</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-oscommerce"></i>social-oscommerce
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-pandora"></i>social-pandora</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-photobucket"></i>social-photobucket
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-picasa"></i>social-picasa</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-pinterest"></i>social-pinterest
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-prestashop"></i>social-prestashop
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-readernaut"></i>social-readernaut
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-social-silverstripe"></i>social-silverstripe</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-slidshare"></i>social-slidshare
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-soundcloud"></i>social-soundcloud
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-spotify"></i>social-spotify</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-social-stack-exchange"></i>social-stack-exchange</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-social-stack-overflow"></i>social-stack-overflow</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-steam"></i>social-steam</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-stumbleupon"></i>social-stumbleupon
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-tagged"></i>social-tagged</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-technorati"></i>social-technorati
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-social-virtuemart"></i>social-virtuemart
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-social-youtube-play"></i>social-youtube-play</div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Sport</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-badminton-birdie"></i>badminton-birdie
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-skydiving-goggles"></i>skydiving-goggles
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-ambulance-crescent"></i>ambulance-crescent
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-ambulance-cross"></i>ambulance-cross</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-articulated-truck"></i>articulated-truck
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-hail-rainy-night"></i>hail-rainy-night
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-hail-rainy-sunny"></i>hail-rainy-sunny
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-hail-thunder-night"></i>hail-thunder-night
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-hail-thunder-sunny"></i>hail-thunder-sunny
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-showy-night-hail"></i>showy-night-hail
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-snowy-night-rainy"></i>snowy-night-rainy
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-snowy-sunny-hail"></i>snowy-sunny-hail
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-snowy-sunny-rainy"></i>snowy-sunny-rainy
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-snowy-thunder"></i>snowy-thunder</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-snowy-thunder-night"></i>snowy-thunder-night</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-snowy-thunder-sunny"></i>snowy-thunder-sunny</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-snowy-windy"></i>snowy-windy</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-snowy-windy-night"></i>snowy-windy-night
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-snowy-windy-sunny"></i>snowy-windy-sunny
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-windy-thunder-raining"></i>windy-thunder-raining</div>
          </div>
        </div>
      </div>
    </div>
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Web Application</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-close-line-circled"></i>close-line-circled
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-close-line-squared"></i>close-line-squared
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-close-line-squared-alt"></i>close-line-squared-alt</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-close-squared"></i>close-squared</div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-close-squared-alt"></i>close-squared-alt
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-code-not-allowed"></i>code-not-allowed
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-exclamation-circle"></i>exclamation-circle
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-exclamation-square"></i>exclamation-square
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4"><i
                class="icofont icofont-exclamation-tringle"></i>exclamation-tringle</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-fire-extinguisher"></i>fire-extinguisher
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-football-american"></i>football-american
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4"><i class="icofont icofont-verification-check"></i>verification-check
            </div>
