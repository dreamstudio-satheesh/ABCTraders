  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Font Awesome Icons</li>
      </ol>
    </nav>
  </div>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2 class="m-b-0"><span>20</span> Icons</h2>
        </div>
        <div class="card-body">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Currency Icons</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-bitcoin"></i> fa-bitcoin<span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-btc"></i> fa-btc</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-cny"></i> fa-cny<span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-dollar"></i> fa-dollar <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-eur"></i> fa-eur</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-euro"></i> fa-euro <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-rmb"></i> fa-rmb <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-rouble"></i> fa-rouble <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-rub"></i> fa-rub</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-ruble"></i> fa-ruble <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-rupee"></i> fa-rupee <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-try"></i> fa-try</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-turkish-lira"></i> fa-turkish-lira <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-usd"></i> fa-usd</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-won"></i> fa-won <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-yen"></i> fa-yen <span
                class="text-muted">(alias)</span></div>
          </div>
        </div>
      </div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Web App Icons</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-automobile"></i> fa-automobile <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-ban"></i> fa-ban</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-bank"></i> fa-bank <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-cab"></i> fa-cab <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-caret-square-o-down"></i> fa-caret-square-o-down
            </div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-caret-square-o-left"></i> fa-caret-square-o-left
            </div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-caret-square-o-right"></i> fa-caret-square-o-right
            </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-dashboard"></i> fa-dashboard <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-edit"></i> fa-edit <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-exclamation-triangle"></i> fa-exclamation-triangle
            </div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-external-link"></i> fa-external-link</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-external-link-square"></i> fa-external-link-square
            </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-movie-o"></i> fa-file-movie-o <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-pdf-o"></i> fa-file-pdf-o</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-photo-o"></i> fa-file-photo-o <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-picture-o"></i> fa-file-picture-o <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-powerpoint-o"></i> fa-file-powerpoint-o</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-sound-o"></i> fa-file-sound-o <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-file-zip-o"></i> fa-file-zip-o <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-flash"></i> fa-flash <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-gear"></i> fa-gear <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-gears"></i> fa-gears <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-group"></i> fa-group <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-image"></i> fa-image <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-institution"></i> fa-institution <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-legal"></i> fa-legal <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-life-bouy"></i> fa-life-bouy <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-life-ring"></i> fa-life-ring</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-life-saver"></i> fa-life-saver <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-mail-forward"></i> fa-mail-forward <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-mail-reply"></i> fa-mail-reply <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-mail-reply-all"></i> fa-mail-reply-all <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-mobile-phone"></i> fa-mobile-phone <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-money"></i> fa-money</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-moon-o"></i> fa-moon-o</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-mortar-board"></i> fa-mortar-board <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-music"></i> fa-music</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-navicon"></i> fa-navicon <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-photo"></i> fa-photo <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-reorder"></i> fa-reorder <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-send"></i> fa-send <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-send-o"></i> fa-send-o <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-sort-down"></i> fa-sort-down <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-sort-up"></i> fa-sort-up <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-star-half-empty"></i> fa-star-half-empty <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-star-half-full"></i> fa-star-half-full <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-support"></i> fa-support <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-toggle-down"></i> fa-toggle-down <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-toggle-left"></i> fa-toggle-left <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-toggle-right"></i> fa-toggle-right <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-toggle-up"></i> fa-toggle-up <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-unsorted"></i> fa-unsorted <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-warning"></i> fa-warning <span
                class="text-muted">(alias)</span></div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Spinner Icons</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-spin fa-gear"></i> fa-gear <span
                class="text-muted">(alias)</span></div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Form Control Icons</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-check-square"></i> fa-check-square</div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Text Editor Icons</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-chain"></i> fa-chain <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-copy"></i> fa-copy <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-cut"></i> fa-cut <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-dedent"></i> fa-dedent <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-eraser"></i> fa-eraser</div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-paste"></i> fa-paste <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-repeat"></i> fa-repeat</div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-rotate-left"></i> fa-rotate-left <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-rotate-right"></i> fa-rotate-right <span
                class="text-muted">(alias)</span></div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-save"></i> fa-save <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-unlink"></i> fa-unlink <span
                class="text-muted">(alias)</span></div>
          </div>
        </div>
      </div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Directional Icons</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrow-circle-o-down"></i> fa-arrow-circle-o-down
            </div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrow-circle-o-left"></i> fa-arrow-circle-o-left
            </div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrow-circle-o-right"></i> fa-arrow-circle-o-right
            </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-chevron-circle-down"></i> fa-chevron-circle-down
            </div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-chevron-circle-left"></i> fa-chevron-circle-left
            </div>
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-chevron-circle-right"></i> fa-chevron-circle-right
            </div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Video Player Icons</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrows-alt"></i> fa-arrows-alt</div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row icon-lists">
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-ge"></i> fa-ge <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-ra"></i> fa-ra <span
                class="text-muted">(alias)</span></div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-wechat"></i> fa-wechat <span
                class="text-muted">(alias)</span></div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2 class="m-b-0">Medical Icons</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists">
