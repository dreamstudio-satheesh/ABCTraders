  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Whether Icons</li>
      </ol>
    </nav>
  </div>
</div>
    ...
    <div class="col-sm-12">
      <div class="card title-line">
        <div class="card-header">
          <h2 class="m-b-0">Whether Icons with Animations</h2>
        </div>
        <div class="card-body">
          <div class="row icon-lists whether-icon">
              ...
              <svg class="climacon climacon_moonFill" id="moonfill" version="1.1" viewBox="15 15 70 70">
                <g class="climacon_iconWrap climacon_iconWrap-moonFill">
                  <g class="climacon_componentWrap climacon_componentWrap-moon">
                    ...
                    <path class="climacon_component climacon_component-fill climacon_component-fill_moon" fill="#FFFFFF"
              ...
              <svg class="climacon climacon_tornado" id="tornado" version="1.1" viewBox="15 15 70 70">
                <g class="climacon_iconWrap climacon_iconWrap-tornado">
                  <g class="climacon_componentWrap climacon_componentWrap-tornado">
                    <path class="climacon_component climacon_component-stroke climacon_component-stroke_tornadoLine"
            ...
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudDrizzleSunFill" id="cloudDrizzleSunFill" version="1.1"
                viewBox="15 15 70 70">
            ...
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudDrizzleMoonFill" id="cloudDrizzleMoonFill" version="1.1"
                viewBox="15 15 70 70">
            ...
            <!-- cloudDrizzleAlt-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudDrizzleFillAlt" id="cloudDrizzleAltfill1" version="1.1"
                viewBox="15 15 70 70">
            ...
            <!-- cloudDrizzleFillAlt-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudDrizzleSunAlt" id="cloudDrizzleSunAlt" version="1.1"
                viewBox="15 15 70 70">
            ...
            <!-- cloudDrizzleSunAlt-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudDrizzleSunFillAlt" id="cloudDrizzleSunFillAlt" version="1.1"
                viewBox="15 15 70 70">
            ...
            <!-- cloudDrizzleMoonAlt-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudDrizzleMoonFillAlt" id="cloudDrizzleMoonFillAlt" version="1.1"
                viewBox="15 15 70 70">
            ...
            <!-- cloudRainMoon-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudRainMoonFill" id="cloudRainMoonFill" version="1.1"
                viewBox="15 15 70 70">
            ...
            <!-- cloudRainSunAlt-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudSunRainAltFill" id="cloudRainSunAltFill" version="1.1"
                viewBox="15 15 70 70">
            ...
            <!-- cloudRainMoonAlt-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudMoonRainAltFill" id="cloudRainMoonAltFill" version="1.1"
                viewBox="15 15 70 70">
                <g class="climacon_iconWrap climacon_iconWrap-cloudRainSunAlt">
                  <g class="climacon_wrapperComponent climacon_wrapperComponent-moon climacon_componentWrap-moon_cloud">
                    <path class="climacon_component climacon_component-stroke climacon_component-stroke_sunBody"
                ...
                <g class="climacon_iconWrap climacon_iconWrap-cloudHailAltMoon">
                  <g clip-path="url(#cloudFillClip)">
                    <g
                      ...
                      <path class="climacon_component climacon_component-fill climacon_component-fill_moon"
                        fill="#FFFFFF"
                        d="M59.235,30.851c-3.556,0.813-6.211,3.989-6.211,7.792c0,4.417,3.581,7.999,7.999,7.999c3.802,0,6.979-2.655,7.791-6.211C63.961,39.527,60.139,35.705,59.235,30.851z">
                      </path>
                    </g>
            ...
            <!-- cloudHailAltMoon-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudHailAltMoonFill" id="cloudHailAltMoonFill" version="1.1"
                viewBox="15 15 70 70">
                <g class="climacon_iconWrap climacon_iconWrap-cloudHailAltMoon">
                  <g class="climacon_wrapperComponent climacon_wrapperComponent-moon climacon_componentWrap-moon_cloud">
                    <path class="climacon_component climacon_component-stroke climacon_component-stroke_sunBody"
            ...
            <!-- cloudSnowMoon-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudSnowMoonFill" id="cloudSnowMoonFill" version="1.1"
                viewBox="15 15 70 70">
                ...
                <g class="climacon_iconWrap climacon_iconWrap-cloudSnowAlt">
                  <g class="climacon_wrapperComponent climacon_wrapperComponent-snowAlt">
                    <g class="climacon_component climacon_component climacon_component-snowAlt"
                      ...
                      <path class="climacon_component climacon_component-stroke climacon_component-stroke_snowAlt"
                ...
                <g class="climacon_iconWrap climacon_iconWrap-cloudSnowAltFill">
                  <g class="climacon_wrapperComponent climacon_wrapperComponent-snowAlt">
                    <g class="climacon_component climacon_component climacon_component-snowAlt">
                      ...
                      <circle class="climacon_component climacon_component-fill climacon_component-fill_snowAlt"
            ...
            <!-- cloudSnowSunAlt-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudSnowSunAltFill" id="cloudSnowSunAltFill" version="1.1"
                viewBox="15 15 70 70">
            ...
            <!-- cloudSnowMoonAlt-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudSnowAltFill" id="cloudSnowAltFill1" version="1.1"
                viewBox="15 15 70 70">
                <g class="climacon_iconWrap climacon_iconWrap-cloudSnowAltFill">
                  <g class="climacon_wrapperComponent climacon_wrapperComponent-moon climacon_componentWrap-moon_cloud">
                    <path class="climacon_component climacon_component-stroke climacon_component-stroke_sunBody"
            ...
            <!-- cloudFogMoon-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudFogMoonFill" id="cloudFogMoonFill" version="1.1"
                xmlns="http://www.w3.org/2000/svg" viewBox="15 15 70 70">
            ...
            <!-- cloudFogSunAlt-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudFogSunAltFill" id="cloudFogSunAltFill" version="1.1"
                viewBox="15 15 70 70">
            ...
            <!-- cloudFogMoonAlt-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudFogMoonAltFill" id="cloudFogMoonAltFill" version="1.1"
                viewBox="15 15 70 70">
                ...
                <g class="climacon_iconWrap climacon_iconWrap-cloudFogMoonAltFill">
                  ...
                  <g clip-path="url(#newMoonCloudFillClip)">
                    <g
                      class="climacon_wrapperComponent climacon_wrapperComponent-moon climacon_componentWrap-moon_cloud">
                      <path class="climacon_component climacon_component-stroke climacon_component-stroke_moonBody"
                        d="M61.023,50.641c-6.627,0-11.999-5.372-11.999-11.998c0-6.627,5.372-11.999,11.999-11.999c0.755,0,1.491,0.078,2.207,0.212c-0.132,0.576-0.208,1.173-0.208,1.788c0,4.418,3.582,7.999,8,7.999c0.614,0,1.212-0.076,1.788-0.208c0.133,0.717,0.211,1.452,0.211,2.208C73.021,45.269,67.649,50.641,61.023,50.641z">
                      </path>
                      <path class="climacon_component climacon_component-fill climacon_component-fill_moon"
                        fill="#FFFFFF"
            ...
            <!-- cloudFogMoonAltFill-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudLightning" id="cloudLightningfill2" version="1.1"
                viewBox="15 15 70 70">
            ...
            <!-- cloudLightning-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudLightningFill" id="cloudLightningFill" version="1.1"
                viewBox="15 15 70 70">
            ...
            <!-- cloudLightningFill-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudLightningSun" id="cloudLightningfill1" version="1.1"
                viewBox="15 15 70 70">
            ...
            <!-- cloudLightningSun-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudLightningSunFill" id="cloudLightningSunFill" version="1.1"
                viewBox="15 15 70 70">
                <g class="climacon_iconWrap climacon_iconWrap-cloudLightning">
            ...
            <!-- cloudLightningMoon-->
            <div class="col-lg-2 col-3">
              <svg class="climacon climacon_cloudLightningMoonFill" id="cloudLightningMoonFill" version="1.1"
                viewBox="15 15 70 70">
                ...
                <g class="climacon_iconWrap climacon_iconWrap-sunrise">
                  <g class="climacon_componentWrap climacon_componentWrap-sunrise">
                    ...
                    <g class="climacon_wrapperComponent climacon_wrapperComponent-horizonLine">
                      <path class="climacon_component climacon_component-stroke climacon_component-stroke_horizonLine"
                ...
                <g class="climacon_iconWrap climacon_iconWrap-sunriseFill">
                  <g class="climacon_componentWrap climacon_componentWrap-sunrise">
                    ...
                    <g class="climacon_wrapperComponent climacon_wrapperComponent-sunBody">
                      ...
                      <circle class="climacon_component climacon_component-fill climacon_component-fill_sunBody"
                        fill="#FFFFFF" cx="50.001" cy="56" r="7.999"></circle>
                    </g>
                    <g class="climacon_wrapperComponent climacon_wrapperComponent-arrow">
                      <path
                        class="climacon_component climacon_component-stroke climacon_component-stroke_arrow climacon_component-stroke_arrow-up"
                  ...
                  <g clip-path="url(#sunriseFillClip)">
                    <g class="climacon_componentWrap climacon_componentWrap-sunriseAlt">
                      ...
                      <g class="climacon_wrapperComponent climacon_wrapperComponent-sunBody">
                        ...
                        <circle class="climacon_component climacon_component-fill climacon_component-fill_sunBody"
                          fill="#FFFFFF" cx="50.001" cy="76" r="7.999"></circle>
                      </g>
                    </g>
                  </g>
                  <g class="climacon_wrapperComponent climacon_wrapperComponent-horizonLine">
