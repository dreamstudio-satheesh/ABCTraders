  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Tasks</li>
      </ol>
    </nav>
  </div>
</div>
  ...
  <div class="email-wrap bookmark-wrap">
    <div class="row">
      <div class="col-xl-3 box-col-6">
        <div class="md-sidebar"><a class="btn btn-primary md-sidebar-toggle" href="#!">task filter</a>
                  ...
                  <div class="email-app-sidebar left-bookmark task-sidebar">
                    ...
                    <ul class="nav main-menu" role="tablist">
                      ...
                      <li><a class="show" id="pills-todaytask-tab" data-bs-toggle="pill" href="#pills-todaytask"
                          role="tab" aria-controls="pills-todaytask" aria-selected="false"><span class="title"> Today's
                            Tasks</span></a></li>
                      <li><a class="show" id="pills-delayed-tab" data-bs-toggle="pill" href="#pills-delayed" role="tab"
                          aria-controls="pills-delayed" aria-selected="false"><span class="title"> Delayed
                            Tasks</span></a></li>
                      <li><a class="show" id="pills-upcoming-tab" data-bs-toggle="pill" href="#pills-upcoming"
                          role="tab" aria-controls="pills-upcoming" aria-selected="false"><span class="title">Upcoming
                            Tasks</span></a></li>
                      <li><a class="show" id="pills-weekly-tab" data-bs-toggle="pill" href="#pills-weekly" role="tab"
                          aria-controls="pills-weekly" aria-selected="false"><span class="title">This week
                            tasks</span></a></li>
                      <li><a class="show" id="pills-monthly-tab" data-bs-toggle="pill" href="#pills-monthly" role="tab"
                          aria-controls="pills-monthly" aria-selected="false"><span class="title">This month
                            tasks</span></a></li>
                      <li><a class="show" id="pills-assigned-tab" data-bs-toggle="pill" href="#pills-assigned"
                          role="tab" aria-controls="pills-assigned" aria-selected="false"><span class="title">Assigned
                            to me</span></a></li>
                      <li><a class="show" id="pills-tasks-tab" data-bs-toggle="pill" href="#pills-tasks" role="tab"
                          aria-controls="pills-tasks" aria-selected="false"><span class="title">My tasks</span></a></li>
                      <li>
                        <hr>
                      </li>
                      ...
                      <li><a class="show" id="pills-newsletter-tab" data-bs-toggle="pill" href="#pills-newsletter"
                          role="tab" aria-controls="pills-newsletter" aria-selected="false"><span class="title">
                            Newsletter</span></a></li>
                      <li><a class="show" id="pills-business-tab" data-bs-toggle="pill" href="#" role="tab"
                          aria-selected="false"><span class="title"> Business</span></a></li>
                      <li><a class="show" id="pills-holidays-tab" data-bs-toggle="pill" href="#" role="tab"
                          aria-selected="false"><span class="title"> Holidays</span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="ps-0">
              <div class="tab-content">
                <div class="tab-pane fade active show" id="pills-created" role="tabpanel"
                  ...
                  <div class="card mb-0">
                    <div class="card-header d-flex">
                      <h2 class="mb-0">Created by me</h2><a href="#!" onclick="window.print();"><i class="me-2"
                        ...
                        <div class="table-responsive custom-scrollbar">
                          <table class="table">
                            <tr>
                              ...
                              <td>
                                <p class="task_desc_0">In our future client meeting, let's talk about the project's
                                  development, significant milestones.</p>
                              </td>
                              <td><a class="me-2" href="#!"><i data-feather="link"></i></a><a href="#!"><i
                            ...
                            <tr>
                              ...
                              <td>
                                <p class="task_desc_0">Join us for a thought-provoking webinar on aviation developments
                                  and how they affect the sector.</p>
                              </td>
                              <td><a class="me-2" href="#!"><i data-feather="link"></i></a><a href="#!"><i
                                    data-feather="more-horizontal"></i></a></td>
                              <td><a href="#!"><i data-feather="trash-2"></i></a></td>
                            ...
                            <tr>
                              ...
                              <td>
                                <p class="task_desc_0">By signing up for our email newsletter, you may be informed about
                                  our most recent news and promotions.</p>
                              </td>
                              <td><a class="me-2" href="#!"><i data-feather="link"></i></a><a href="#!"><i
                                    data-feather="more-horizontal"></i></a></td>
                              <td><a href="#!"><i data-feather="trash-2"></i></a></td>
                            ...
                            <tr>
                              ...
                              <td>
                                <p class="task_desc_0">We're thrilled to announce the publication of a brand-new edition
                                  of our podcast.</p>
                              </td>
                              <td><a class="me-2" href="#!"><i data-feather="link"></i></a><a href="#!"><i
                                    data-feather="more-horizontal"></i></a></td>
                            ...
                            <tr>
                              ...
                              <td>
                                <p class="task_desc_0">Visit our website to find a delicious selection of lunch
                                  alternatives that will please every appetite.</p>
                              </td>
                              <td><a class="me-2" href="#!"><i data-feather="link"></i></a><a href="#!"><i
                                    data-feather="more-horizontal"></i></a></td>
                              <td><a href="#!"><i data-feather="trash-2"></i></a></td>
                            ...
                            <tr>
                              ...
                              <td>
                                <p class="task_desc_0">Getting ready to meet with the customer to go through project
                                  updates, objectives, and next actions.</p>
                              </td>
                              <td><a class="me-2" href="#!"><i data-feather="link"></i></a><a href="#!"><i
                                    data-feather="more-horizontal"></i></a></td>
                              <td><a href="#!"><i data-feather="trash-2"></i></a></td>
                ...
                <div class="fade tab-pane" id="pills-todaytask" role="tabpanel" aria-labelledby="pills-todaytask-tab">
                  <div class="card mb-0">
                    <div class="card-header d-flex">
                      <h6 class="mb-0">Today's Tasks</h6><a href="#!"><i class="me-2"
                          data-feather="printer"></i>Print</a>
                    </div>
                    <div class="card-body">
                ...
                <div class="fade tab-pane" id="pills-delayed" role="tabpanel" aria-labelledby="pills-delayed-tab">
                  <div class="card mb-0">
                    <div class="card-header d-flex">
                      <h6 class="mb-0">Delayed Tasks</h6><a href="#!"><i class="me-2"
                          data-feather="printer"></i>Print</a>
                    </div>
                    <div class="card-body">
                ...
                <div class="fade tab-pane" id="pills-upcoming" role="tabpanel" aria-labelledby="pills-upcoming-tab">
                  <div class="card mb-0">
                    <div class="card-header d-flex">
                      <h6 class="mb-0">Upcoming Tasks</h6><a href="#!"><i class="me-2"
                          data-feather="printer"></i>Print</a>
                    </div>
                    <div class="card-body">
                      <div class="details-bookmark text-center"><span>No tasks found.</span></div>
                ...
                <div class="fade tab-pane" id="pills-weekly" role="tabpanel" aria-labelledby="pills-weekly-tab">
                  <div class="card mb-0">
                    <div class="card-header d-flex">
                      <h6 class="mb-0">This Week Tasks</h6><a href="#!"><i class="me-2"
                          data-feather="printer"></i>Print</a>
                    </div>
                    <div class="card-body">
                      <div class="details-bookmark text-center"><span>No tasks found.</span></div>
                ...
                <div class="fade tab-pane" id="pills-monthly" role="tabpanel" aria-labelledby="pills-monthly-tab">
                  <div class="card mb-0">
                    <div class="card-header d-flex">
                      <h6 class="mb-0">This Month Tasks</h6><a href="#!"><i class="me-2"
                          data-feather="printer"></i>Print</a>
                    </div>
                    <div class="card-body">
                      <div class="details-bookmark text-center"><span>No tasks found.</span></div>
                        ...
                        <div class="table-responsive">
                          <table class="table">
                            <tr>
                              ...
                              <td>
                                <p class="task_desc_0">A task is a particular assignment or responsibility that must be
                                  finished by a certain date or deadline. </p>
                              </td>
                              <td><a class="me-2" href="#!"><i data-feather="link"></i></a><a href="#!"><i
                                    data-feather="more-horizontal"></i></a></td>
                              <td><a href="#!"><i data-feather="trash-2"></i></a></td>
                            ...
                            <tr>
                              ...
                              <td>
                                <p class="task_desc_0">Well-structured and organised task list in order to manage and
                                  accomplish jobs successfully. </p>
                              </td>
                              <td><a class="me-2" href="#!"><i data-feather="link"></i></a><a href="#!"><i
                                    data-feather="more-horizontal"></i></a></td>
                              <td><a href="#!"><i data-feather="trash-2"></i></a></td>
