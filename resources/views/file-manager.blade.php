  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">File Manager</li>
      </ol>
    </nav>
  </div>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-xl-3 box-col-6 pe-0">
      <div class="md-sidebar"><a class="btn btn-primary md-sidebar-toggle" href="javascript:void(0)">file filter</a>
                  ...
                  <li>
                    <div class="pricing-plan">
                      ...
                      <div class="btn btn-outline-primary btn-xs">Selected</div><img class="bg-img"
                        src="{{ asset('assets/images/dashboard/folder.png') }}" alt="">
                    </div>
                  </li>
                  <li>
                    <div class="pricing-plan">
                      ...
                      <div class="btn btn-outline-primary btn-xs">Contact Us</div><img class="bg-img"
                        src="{{ asset('assets/images/dashboard/folder1.png') }}" alt="">
                    </div>
                  </li>
                </ul>
              </div>
      ...
      <div class="file-content">
        <div class="card">
          ...
          <div class="card-body file-manager">
            <h2>All Files</h2>
            <p class="f-m-light mb-2">Recently opened files</p>
            <ul class="files">
              <li class="file-box">
            ...
            <ul class="folder">
              <li class="folder-box">
                <div class="d-flex"><i class="fa fa-file-archive-o f-36 txt-warning"></i>
              ...
              <li class="folder-box">
                <div class="d-flex"><i class="fa fa-folder f-36 txt-warning"></i>
                  <div class="flex-grow-1 ms-3">
                    <h6 class="mb-0">Endless admin</h6>
                    <p>101 files, 10MB</p>
                  </div>
