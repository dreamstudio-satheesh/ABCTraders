  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Checkbox &amp; Radio</li>
      </ol>
    </nav>
  </div>
</div>
...
<div class="container-fluid">
  <div class="row">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <p class="f-m-light mt-1">
            Use the <code>.form-check-input </code>and <code>.form-check-label </code>for checkbox.</p>
        </div>
        <div class="card-body">
          <div class="row g-3">
            ...
            <div class="col-sm-6 col-xl-4">
              <div class="card-wrapper border rounded-3 checkbox-checked">
                ...
                <div class="form-check">
                  <input class="form-check-input" id="flexCheckCheckedDisabled" type="checkbox" value="" checked=""
                    disabled="">
            ...
            <div class="col-sm-6 col-xl-4">
              <div class="card-wrapper border rounded-3 checkbox-checked">
                ...
                <div class="form-check form-check-reverse">
                  <input class="form-check-input" id="reverseCheck2" type="checkbox" value="" disabled="" checked="">
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          ...
          <p class="f-m-light mt-1">
            Use the <code>.form-check-input </code>and <code>.form-check-label </code>for checkbox. And filled checkbox
            used <code>.checkbox-solid-*</code> and bordered checkbox used <code>.checkbox-*</code>.</p>
        </div>
        <div class="card-body">
          <div class="row g-3">
                ...
                <div class="form-check checkbox checkbox-primary ps-0 main-icon-checkbox">
                  <ul class="checkbox-wrapper">
                    ...
                    <li>
                      ...
                      <label class="form-check-label" for="checkbox-icon1"><i class="fa fa-user"> </i><span>User
                        </span></label>
                    </li>
                    <li>
                      ...
                      <label class="form-check-label" for="checkbox-icon2"><i class="fa fa-tags">
                        </i><span>Tags</span></label>
                    </li>
                    <li>
                      <input class="form-check-input checkbox-shadow" id="checkbox-icon3" type="checkbox">
                      <label class="form-check-label" for="checkbox-icon3"><i class="fa fa-android"></i><span>Android
                        </span></label>
                    </li>
                    <li>
                      ...
                      <label class="form-check-label" for="checkbox-icon4"><i
                          class="fa fa-eye-slash"></i><span>Hidden</span></label>
                    </li>
                    <li>
                      ...
                      <label class="form-check-label" for="checkbox-icon5"><i
                          class="fa fa-folder-open"></i><span>Folder</span></label>
                    </li>
                    <li>
            ...
            <div class="col-xl-4 col-sm-6">
              <div class="card-wrapper border rounded-3 h-100 checkbox-checked">
                ...
                <div class="form-check checkbox checkbox-solid-success">
                  ...
                  <label class="form-check-label" for="solid4">Success - checkbox-solid-success</label>
                </div>
                <div class="form-check checkbox checkbox-solid-primary">
                  <input class="form-check-input" id="solid5" type="checkbox">
                  <label class="form-check-label" for="solid5">Primary - checkbox-solid-primary </label>
                </div>
                <div class="form-check checkbox checkbox-solid-secondary">
                  <input class="form-check-input" id="solid6" type="checkbox">
                  <label class="form-check-label" for="solid6">Secondary - checkbox-solid-secondary </label>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <ul class="radio-wrapper">
                    ...
                    <li>
                      ...
                      <label class="form-check-label" for="radio-icon8"><i
                          class="fa fa-user"></i><span>Users</span></label>
                    </li>
                    <li>
                      ...
                      <label class="form-check-label" for="radio-icon9"><i
                          class="fa fa-trash-o"></i><span>Trash</span></label>
                    </li>
                    <li>
                      ...
                      <label class="form-check-label" for="radio-icon10"><i
                          class="fa fa-github"></i><span>github</span></label>
                    </li>
                    <li>
                      ...
                      <label class="form-check-label" for="radio-icon11"><i
                          class="fa fa-play-circle"></i><span>Play</span></label>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6 col-xl-4">
              <div class="card-wrapper border rounded-3 rtl-input checkbox-checked">
                ...
                <div class="form-check form-switch">
                  <input class="form-check-input" id="flexSwitchCheckDisabled" type="checkbox" role="switch"
                    disabled="">
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h2>Inline Input-types</h2>
          <p class="f-m-light mt-1">
            Group checkboxes or radios on the same horizontal row by adding <code>.form-check-inline </code>to
          ...
          <div class="row g-3">
              ...
              <div class="card-wrapper border rounded-3 checkbox-checked">
                ...
                <div class="form-check-size rtl-input">
                  <div class="form-check form-check-inline">
                    <input class="form-check-input me-2" id="inlineCheckbox1" type="checkbox" value="option1"
                      checked="">
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input me-2" id="inlineCheckbox3" type="checkbox" value="option3"
                      disabled="">
            ...
            <div class="col-md-6 col-xl-4">
              <div class="card-wrapper border rounded-3 checkbox-checked">
                ...
                <div class="form-check-size rtl-input">
                  <div class="form-check form-check-inline">
                    <input class="form-check-input me-2" id="inlineRadio1" type="radio" name="inlineRadioOptions"
                      value="option1" checked="">
                    <label class="form-check-label" for="inlineRadio1">1</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input me-2" id="inlineRadio2" type="radio" name="inlineRadioOptions"
                      value="option2">
                    <label class="form-check-label" for="inlineRadio2">2</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input me-2" id="inlineRadio3" type="radio" name="inlineRadioOptions"
              ...
              <div class="card-wrapper border rounded-3 checkbox-checked">
                ...
                <div class="form-check-size">
                  <div class="form-check form-switch form-check-inline">
                    <input class="form-check-input check-size" id="flexSwitchCheckDefault2" type="checkbox"
                      role="switch" checked="">
                  </div>
                  <div class="form-check form-switch form-check-inline">
                    <input class="form-check-input check-size" id="flexSwitchCheckDefault3" type="checkbox"
                      role="switch">
                  </div>
                  <div class="form-check form-switch form-check-inline">
                    <input class="form-check-input check-size" id="flexSwitchCheckDisabled3" type="checkbox"
    ...
    <div class="col-xl-6">
      <div class="card height-equal">
        <div class="card-header">
          <h2>Basic Radio and Checkbox</h2>
          <p class="f-m-light mt-1">
              ...
              <div class="card-wrapper border rounded-3 checkbox-checked">
                ...
                <div class="form-check-size">
                  <div class="form-check form-check-inline radio radio-primary">
                    <input class="form-check-input" id="radioinline1" type="radio" name="radio5" value="option5"
                      checked="">
    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">
          ...
          <p class="f-m-light mt-1">
            The choice between these two approaches will depend on the type of toggle you are creating, and whether or
            not the toggle will make sense to users when announced as a checkbox or as an actual button.
            <code>[any one selected]</code>.
          </p>
        </div>
        <div class="card-body common-flex main-radio-toggle">
          <input class="btn-check" id="option1" type="radio" name="options" checked="">
          ...
          <input class="btn-check" id="option3" type="radio" name="options" disabled="">
          <label class="btn list-light-secondary" for="option3">Disabled</label>
          <input class="btn-check" id="option4" type="radio" name="options">
    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">
          <h2>Outlined Checkbox Styles</h2>
          <p class="f-m-light mt-1">
            The choice between these two approaches will depend on the type of toggle you are creating, and whether or
            not the toggle will make sense to users when announced as a checkbox or as an actual button.
