  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500">Forms</li>
        <li class="breadcrumb-item f-w-500 active">Validation Forms</li>
      </ol>
    </nav>
  </div>
</div>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h2>Tooltip Form Validation</h2>
          <p class="f-m-light mt-1">
            If your form layout allows it, you can swap the <code>.{valid|invalid}</code>-feedback classes
            for<code>.{valid|invalid}</code>-tooltip classes to display validation feedback in a styled tooltip. Be sure
            to have a parent with <code>position: relative</code> on it for tooltip positioning.</p>
        </div>
        <div class="card-body">
      ...
      <div class="card height-equal">
        <div class="card-header">
          ...
          <p class="f-m-light mt-1">
            ...
            Depending on your browser and OS,While these feedback styles cannot be styled with CSS, you can still
        ...
        <div class="card-body custom-input">
          <form class="row g-3">
            ...
            <div class="col-12 checkbox-checked">
              ...
              <label class="form-check-label" for="flexCheckDefault">By proceeding, you agree to the terms and
                conditions</label>
            </div>
            <div class="col-12">
