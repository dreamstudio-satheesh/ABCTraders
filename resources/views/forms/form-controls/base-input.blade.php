  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Base Inputs</li>
      </ol>
    </nav>
  </div>
</div>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">
          <h2>Select Sizing</h2>
          <p class="f-m-light mt-1"> <code>.form-select</code> to trigger the custom styles. You may also choose from
            small and large custom selects to match our similarly sized text inputs. class:-
        ...
        <form class="form theme-form dark-inputs">
          <div class="card-body">
            <div class="row">
              <div class="col">
                <div class="mb-3">
                  <label class="form-label" for="exampleFormControlSelect12">Select your favorite roman number</label>
            ...
            <div class="row">
              <div class="col">
                <div class="mb-3">
                  <label class="form-label" for="exampleFormControlSelect13">Select your multiple paintings</label>
                  <select class="form-select btn-square digits custom-scrollbar" id="exampleFormControlSelect13"
                    multiple="">
    ...
    <div class="col-xl-6">
      <div class="card height-equal">
        <div class="card-header">
          <h2>Basic HTML Input Control</h2>
          <p class="f-m-light mt-1">
            Give textual form controls like <code>&lt;input&gt;</code>s and <code>&lt;textarea&gt;</code>s an upgrade
            ...
            <div class="row">
              <div class="col">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-9">
                    <input class="form-control digits" id="example-datetime-local-input" type="datetime-local"
                      value="2024-01-19T18:45:00">
                  </div>
                </div>
                <div class="mb-3 row">
                  <label class="col-sm-3">Date</label>
                  <div class="col-sm-9">
                    <input class="form-control digits" type="date" value="2024-09-01">
                  </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-2">
                    <input class="form-control form-control-color" type="color" value="#009DB5">
                  </div>
                </div>
                <div class="mb-3 row">
    ...
    <div class="col-xl-6">
      <div class="card height-equal">
        <div class="card-header">
          <h2>Basic Floating Input Control</h2>
          <p class="f-m-light mt-1">
            Give textual form controls like <code>&lt;input&gt;</code>s and <code>&lt;textarea&gt;</code>s an upgrade
            with custom styles, sizing, focus states, and more.</p>
        </div>
                  ...
                  <div class="col-sm-9">
                    <div class="input-group has-validation"><span class="input-group-text">@</span>
                      <div class="form-floating is-invalid">
                        <input class="form-control is-invalid" id="floatingInputGroup2" type="text" required="">
                ...
                <div class="mb-0 row">
                  ...
                  <div class="col-sm-9">
                    <div class="row g-2">
                      <div class="col-xxl-6">
                        <div class="form-floating">
                          <input class="form-control" id="floatingInputGrid" type="email" placeholder="name@example.com"
        ...
        <form class="form theme-form dark-inputs">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col">
                <div class="mb-3">
                  <label class="form-label" for="exampleFormControlSelect7">In which career are you interested?</label>
                  <select class="form-select btn-pill digits" id="exampleFormControlSelect7">
                    ...
                    <option>Nonprofit Manager</option>
        ...
        <form class="form theme-form dark-inputs">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col">
                <div class="mb-3">
                  <label class="form-label" for="exampleFormControlSelect18">Select the color you like below</label>
