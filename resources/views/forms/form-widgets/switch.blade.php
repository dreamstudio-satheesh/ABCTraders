  ...
  <div>
    ...
    <nav>
      <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
        ...
        <li class="breadcrumb-item f-w-500 active">Switch</li>
      </ol>
    </nav>
  </div>
</div>
            ...
            <div class="col-md-4 col-sm-6">
              <div class="card-wrapper border rounded-3">
                <div class="form-check-size">
                  ...
                  <div class="form-check form-switch form-check-inline">
                    <input class="form-check-input switch-secondary check-size" type="checkbox" role="switch"
                      checked="">
                  </div>
                  <div class="form-check form-switch form-check-inline">
                  ...
                  <div class="form-check form-switch form-check-inline">
                    <input class="form-check-input switch-danger check-size" type="checkbox" role="switch" checked="">
                  </div>
                  <div class="form-check form-switch form-check-inline">
                    <input class="form-check-input switch-warning check-size" type="checkbox" role="switch" checked="">
                  </div>
                  <div class="form-check form-switch form-check-inline">
                    <input class="form-check-input switch-info check-size" type="checkbox" role="switch" checked="">
                  </div>
                  <div class="form-check form-switch form-check-inline">
                    <input class="form-check-input switch-dark check-size" type="checkbox" role="switch" checked="">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="card-wrapper border rounded-3 common-flex">
                <div class="form-check-size">
                  ...
                  <div class="form-check form-switch form-check-inline">
                    <input class="form-check-input switch-secondary check-size" type="checkbox" role="switch" checked=""
                      disabled="">
                  </div>
                  <div class="form-check form-switch form-check-inline">
                    <input class="form-check-input switch-success check-size" type="checkbox" role="switch" checked=""
    ...
    <div class="col-xl-4 col-sm-6">
      <div class="card height-equal title-line">
        <div class="card-header">
          <h2>Icons Switch</h2>
          <p class="f-m-light mt-1">
            Use the <code>.switch-state </code>and <code>icon-state </code>through defined icons switches.</p>
        </div>
    ...
    <div class="col-md-12">
      <div class="card title-line">
        <div class="card-header">
          <h2>Switch Sizing</h2>
          <p class="f-m-light mt-1">
            Use the <code>.switch-sm</code> and <code>.switch-lg </code>class through defined switch sizing.</p>
        </div>
        <div class="card-body common-flex switch-wrapper">
          <div class="d-flex">
            <label class="col-form-label m-r-10">Small Size</label>
            <div class="text-end switch-sm">
              <label class="switch">
          ...
          <div class="d-flex">
            ...
            <div class="text-end switch-lg">
              <label class="switch">
                <input type="checkbox" checked=""><span class="switch-state large-switch"></span>
              </label>
            </div>
          </div>
          <div class="d-flex">
            ...
            <div class="text-end switch-lg">
              <label class="switch">
                <input type="checkbox"><span class="switch-state large-switch"></span>
              </label>
            </div>
          </div>
          <div class="d-flex">
            ...
            <div class="text-end switch-lg">
              <label class="switch">
                <input type="checkbox" disabled=""><span class="switch-state large-switch"></span>
              </label>
            </div>
          </div>
        </div>
    ...
    <div class="col-md-12">
      <div class="card title-line">
        ...
        <div class="card-body common-flex switch-wrapper">
          <div class="d-flex">
            <label class="col-form-label m-r-10">Small Size</label>
            <div class="text-end switch-sm icon-state">
              <label class="switch">
                <input type="checkbox" checked=""><span class="switch-state"></span>
              </label>
            </div>
          ...
          <div class="d-flex">
            <label class="col-form-label m-r-10">Large Size</label>
            <div class="text-end switch-lg icon-state">
              <label class="switch">
                <input type="checkbox" checked=""><span class="switch-state"></span>
              </label>
            </div>
